...
namespace ORMDiocesis.HelperClasses
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		private void InitLectoresEntityMappings()
		{
			...
			base.AddElementFieldMapping( "LectoresEntity", "Numero", "numero", true, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 26 );
			base.AddElementFieldMapping( "LectoresEntity", "Colonia", "colonia", true, (int)SqlDbType.VarChar, 50, 0, 0, false, "", null, typeof(System.String), 27 );
			base.AddElementFieldMapping( "LectoresEntity", "Email", "email", true, (int)SqlDbType.VarChar, 50, 0, 0, false, "", null, typeof(System.String), 28 );
		}
		...
		private void InitLibroEntityMappings()
		{
			...
			base.AddElementFieldMapping( "LibroEntity", "Edicion", "Edicion", true, (int)SqlDbType.Char, 100, 0, 0, false, "", null, typeof(System.String), 3 );
			...
			base.AddElementFieldMapping( "LibroEntity", "Pasillo", "Pasillo", true, (int)SqlDbType.VarChar, 50, 0, 0, false, "", null, typeof(System.String), 12 );
			base.AddElementFieldMapping( "LibroEntity", "Estante", "Estante", true, (int)SqlDbType.VarChar, 50, 0, 0, false, "", null, typeof(System.String), 13 );
			base.AddElementFieldMapping( "LibroEntity", "Nivel", "Nivel", true, (int)SqlDbType.VarChar, 50, 0, 0, false, "", null, typeof(System.String), 14 );
			base.AddElementFieldMapping( "LibroEntity", "Isbn", "ISBN", true, (int)SqlDbType.VarChar, 200, 0, 0, false, "", null, typeof(System.String), 15 );
			...
			base.AddElementFieldMapping( "LibroEntity", "Numero", "numero", true, (int)SqlDbType.NVarChar, 50, 0, 0, false, "", null, typeof(System.String), 25 );
		}
