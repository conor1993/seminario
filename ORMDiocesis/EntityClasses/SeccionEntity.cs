		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public virtual ORMDiocesis.CollectionClasses.LibroCollection GetMultiLibro(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedLibro || forceFetch || _alwaysFetchLibro) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				_libro.GetMultiManyToOne(null, null, null, null, null, this, null, null, filter);
		...
		public ORMDiocesis.CollectionClasses.AutorCollection GetMultiAutorCollectionViaLibro(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedAutorCollectionViaLibro || forceFetch || _alwaysFetchAutorCollectionViaLibro) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				relations.Add(SeccionEntity.Relations.LibroEntityUsingIdSeccion, "__SeccionEntity__", "Libro_", JoinHint.None);
				relations.Add(LibroEntity.Relations.AutorEntityUsingIdAutor, "Libro_", string.Empty, JoinHint.None);
				filter.Add(new FieldCompareValuePredicate(EntityFieldFactory.Create(SeccionFieldIndex.Id), ComparisonOperator.Equal, this.Id));
		...
		private void InitClassMembers()
		{
			...
			_libro.SetContainingEntityInfo(this, "Seccion");
		...
		public static IPrefetchPathElement PrefetchPathLibro
		{
			get
			{
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroCollection(),
					...
					(int)ORMDiocesis.EntityType.SeccionEntity, (int)ORMDiocesis.EntityType.LibroEntity, 0, null, null, null, "Libro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathAutorCollectionViaLibro
		{
			...
			{
				IRelationCollection relations = new RelationCollection();
				relations.Add(SeccionEntity.Relations.LibroEntityUsingIdSeccion, "__SeccionEntity__", string.Empty, JoinHint.None);
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.AutorCollection(),
					SeccionEntity.Relations.LibroEntityUsingIdSeccion,
					(int)ORMDiocesis.EntityType.SeccionEntity, (int)ORMDiocesis.EntityType.AutorEntity, 0, null, null, relations, "AutorCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathEditorialCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.EditorialCollection(),
					SeccionEntity.Relations.LibroEntityUsingIdSeccion,
					(int)ORMDiocesis.EntityType.SeccionEntity, (int)ORMDiocesis.EntityType.EditorialEntity, 0, null, null, relations, "EditorialCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathBcatEstatusCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroEstatusCollection(),
					SeccionEntity.Relations.LibroEntityUsingIdSeccion,
					(int)ORMDiocesis.EntityType.SeccionEntity, (int)ORMDiocesis.EntityType.LibroEstatusEntity, 0, null, null, relations, "BcatEstatusCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathBcatFormatoCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroFormatoCollection(),
					SeccionEntity.Relations.LibroEntityUsingIdSeccion,
					(int)ORMDiocesis.EntityType.SeccionEntity, (int)ORMDiocesis.EntityType.LibroFormatoEntity, 0, null, null, relations, "BcatFormatoCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathRamaCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.RamaCollection(),
					SeccionEntity.Relations.LibroEntityUsingIdSeccion,
					(int)ORMDiocesis.EntityType.SeccionEntity, (int)ORMDiocesis.EntityType.RamaEntity, 0, null, null, relations, "RamaCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathTematicaCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.TematicaCollection(),
					SeccionEntity.Relations.LibroEntityUsingIdSeccion,
					(int)ORMDiocesis.EntityType.SeccionEntity, (int)ORMDiocesis.EntityType.TematicaEntity, 0, null, null, relations, "TematicaCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathPaisCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.PaisCollection(),
					SeccionEntity.Relations.LibroEntityUsingIdSeccion,
					(int)ORMDiocesis.EntityType.SeccionEntity, (int)ORMDiocesis.EntityType.PaisEntity, 0, null, null, relations, "PaisCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
