...
namespace ORMDiocesis.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'LibroFormato'. <br/><br/>
	/// 
	/// </summary>
#if CF
	...
	[Serializable]
#endif
	public partial class LibroFormatoEntity : EntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private ORMDiocesis.CollectionClasses.LibroEstatusCollection _libroEstatusCollectionViaLibro;
		private bool	_alwaysFetchLibroEstatusCollectionViaLibro, _alreadyFetchedLibroEstatusCollectionViaLibro;
		...
		static LibroFormatoEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public LibroFormatoEntity()
		{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for LibroFormato which data should be fetched into this LibroFormato object</param>
		public LibroFormatoEntity(System.Int32 id)
		{
		...
		public LibroFormatoEntity(System.Int32 id, IPrefetchPath prefetchPathToUse)
		{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for LibroFormato which data should be fetched into this LibroFormato object</param>
		/// <param name="validator">The custom validator object for this LibroFormatoEntity</param>
		public LibroFormatoEntity(System.Int32 id, IValidator validator)
		{
		...
		protected LibroFormatoEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			_libroEstatusCollectionViaLibro = (ORMDiocesis.CollectionClasses.LibroEstatusCollection)info.GetValue("_libroEstatusCollectionViaLibro", typeof(ORMDiocesis.CollectionClasses.LibroEstatusCollection));
			_alwaysFetchLibroEstatusCollectionViaLibro = info.GetBoolean("_alwaysFetchLibroEstatusCollectionViaLibro");
			_alreadyFetchedLibroEstatusCollectionViaLibro = info.GetBoolean("_alreadyFetchedLibroEstatusCollectionViaLibro");
		...
		protected override void PostReadXmlFixups()
		{
			...
			_alreadyFetchedLibroEstatusCollectionViaLibro = (_libroEstatusCollectionViaLibro.Count > 0);
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue("_libroEstatusCollectionViaLibro", _libroEstatusCollectionViaLibro);
			info.AddValue("_alwaysFetchLibroEstatusCollectionViaLibro", _alwaysFetchLibroEstatusCollectionViaLibro);
			info.AddValue("_alreadyFetchedLibroEstatusCollectionViaLibro", _alreadyFetchedLibroEstatusCollectionViaLibro);
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity entity)
		{
			switch(propertyName)
			{
				...
				case "EditorialCollectionViaLibro":
					...
					break;
				case "LibroEstatusCollectionViaLibro":
					_alreadyFetchedLibroEstatusCollectionViaLibro = true;
					if(entity!=null)
					{
						this.LibroEstatusCollectionViaLibro.Add((LibroEstatusEntity)entity);
					}
					break;
		...
		public bool TestOriginalFieldValueForNull(LibroFormatoFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(LibroFormatoFieldIndex fieldIndex)
		{
		...
		public virtual ORMDiocesis.CollectionClasses.LibroCollection GetMultiLibro(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedLibro || forceFetch || _alwaysFetchLibro) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				_libro.GetMultiManyToOne(null, null, null, this, null, null, null, null, filter);
		...
		public ORMDiocesis.CollectionClasses.AutorCollection GetMultiAutorCollectionViaLibro(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedAutorCollectionViaLibro || forceFetch || _alwaysFetchAutorCollectionViaLibro) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				relations.Add(LibroFormatoEntity.Relations.LibroEntityUsingFormato, "__LibroFormatoEntity__", "Libro_", JoinHint.None);
				relations.Add(LibroEntity.Relations.AutorEntityUsingIdAutor, "Libro_", string.Empty, JoinHint.None);
				filter.Add(new FieldCompareValuePredicate(EntityFieldFactory.Create(LibroFormatoFieldIndex.Id), ComparisonOperator.Equal, this.Id));
		...
		public ORMDiocesis.CollectionClasses.LibroEstatusCollection GetMultiLibroEstatusCollectionViaLibro(bool forceFetch)
		{
			return GetMultiLibroEstatusCollectionViaLibro(forceFetch, _libroEstatusCollectionViaLibro.EntityFactoryToUse);
		}
		...
		/// <param name="entityFactoryToUse">The entity factory to use for the GetMultiManyToMany() routine.</param>
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public ORMDiocesis.CollectionClasses.LibroEstatusCollection GetMultiLibroEstatusCollectionViaLibro(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedLibroEstatusCollectionViaLibro || forceFetch || _alwaysFetchLibroEstatusCollectionViaLibro) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				if(base.ParticipatesInTransaction)
				{
					if(!_libroEstatusCollectionViaLibro.ParticipatesInTransaction)
					{
						base.Transaction.Add(_libroEstatusCollectionViaLibro);
					}
				}
				IRelationCollection relations = new RelationCollection();
				IPredicateExpression filter = new PredicateExpression();
				...
				filter.Add(new FieldCompareValuePredicate(EntityFieldFactory.Create(LibroFormatoFieldIndex.Id), ComparisonOperator.Equal, this.Id));
				_libroEstatusCollectionViaLibro.SuppressClearInGetMulti=!forceFetch;
				if(entityFactoryToUse!=null)
				{
					_libroEstatusCollectionViaLibro.EntityFactoryToUse = entityFactoryToUse;
				}
				_libroEstatusCollectionViaLibro.GetMulti(filter, relations);
				_libroEstatusCollectionViaLibro.SuppressClearInGetMulti=false;
				_alreadyFetchedLibroEstatusCollectionViaLibro = true;
			}
			return _libroEstatusCollectionViaLibro;
		}

		/// <summary> Sets the collection parameters for the collection for 'LibroEstatusCollectionViaLibro'. These settings will be taken into account
		/// when the property LibroEstatusCollectionViaLibro is requested or GetMultiLibroEstatusCollectionViaLibro is called.</summary>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return. When set to 0, this parameter is ignored</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified (null), no sorting is applied.</param>
		public virtual void SetCollectionParametersLibroEstatusCollectionViaLibro(long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			_libroEstatusCollectionViaLibro.SortClauses=sortClauses;
			_libroEstatusCollectionViaLibro.MaxNumberOfItemsToReturn=maxNumberOfItemsToReturn;
		}
		...
		protected override bool SetNewFieldValue(int fieldIndex, object value, bool checkForRefetch)
		{
			...
			if(toReturn && Enum.IsDefined(typeof(LibroFormatoFieldIndex), fieldIndex))
			{
				switch((LibroFormatoFieldIndex)fieldIndex)
				{
					default:
						break;
				}
		...
		{
			LibroFormatoDAO dao = (LibroFormatoDAO)CreateDAOInstance();
		...
		protected override void AddInternalsToContext()
		{
			...
			_libroEstatusCollectionViaLibro.ActiveContext = base.ActiveContext;
		...
		/// <param name="id">PK value for LibroFormato which data should be fetched into this LibroFormato object</param>
		/// <param name="validator">The validator object for this LibroFormatoEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		private void InitClassMembers()
		{
			...
			_libro.SetContainingEntityInfo(this, "BcatFormato");
			...
			_libroEstatusCollectionViaLibro = new ORMDiocesis.CollectionClasses.LibroEstatusCollection(new LibroEstatusEntityFactory());
			_alwaysFetchLibroEstatusCollectionViaLibro = false;
			_alreadyFetchedLibroEstatusCollectionViaLibro = false;
		...
		private bool Fetch(System.Int32 id, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			try
			{
				...
				base.Fields[(int)LibroFormatoFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		{
			return DAOFactory.CreateLibroFormatoDAO();
		}
		...
		{
			return new LibroFormatoEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static LibroFormatoRelations Relations
		{
			get	{ return new LibroFormatoRelations(); }
		}
		...
		public static IPrefetchPathElement PrefetchPathLibro
		{
			get
			{
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroCollection(),
					LibroFormatoEntity.Relations.LibroEntityUsingFormato, 
					(int)ORMDiocesis.EntityType.LibroFormatoEntity, (int)ORMDiocesis.EntityType.LibroEntity, 0, null, null, null, "Libro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathAutorCollectionViaLibro
		{
			...
			{
				IRelationCollection relations = new RelationCollection();
				relations.Add(LibroFormatoEntity.Relations.LibroEntityUsingFormato, "__LibroFormatoEntity__", string.Empty, JoinHint.None);
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.AutorCollection(),
					LibroFormatoEntity.Relations.LibroEntityUsingFormato,
					(int)ORMDiocesis.EntityType.LibroFormatoEntity, (int)ORMDiocesis.EntityType.AutorEntity, 0, null, null, relations, "AutorCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathEditorialCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.EditorialCollection(),
					LibroFormatoEntity.Relations.LibroEntityUsingFormato,
					(int)ORMDiocesis.EntityType.LibroFormatoEntity, (int)ORMDiocesis.EntityType.EditorialEntity, 0, null, null, relations, "EditorialCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathLibroEstatusCollectionViaLibro
		{
			get
			{
				IRelationCollection relations = new RelationCollection();
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroEstatusCollection(),
					LibroFormatoEntity.Relations.LibroEntityUsingFormato,
					(int)ORMDiocesis.EntityType.LibroFormatoEntity, (int)ORMDiocesis.EntityType.LibroEstatusEntity, 0, null, null, relations, "LibroEstatusCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathRamaCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.RamaCollection(),
					LibroFormatoEntity.Relations.LibroEntityUsingFormato,
					(int)ORMDiocesis.EntityType.LibroFormatoEntity, (int)ORMDiocesis.EntityType.RamaEntity, 0, null, null, relations, "RamaCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathSeccionCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.SeccionCollection(),
					LibroFormatoEntity.Relations.LibroEntityUsingFormato,
					(int)ORMDiocesis.EntityType.LibroFormatoEntity, (int)ORMDiocesis.EntityType.SeccionEntity, 0, null, null, relations, "SeccionCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathTematicaCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.TematicaCollection(),
					LibroFormatoEntity.Relations.LibroEntityUsingFormato,
					(int)ORMDiocesis.EntityType.LibroFormatoEntity, (int)ORMDiocesis.EntityType.TematicaEntity, 0, null, null, relations, "TematicaCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathPaisCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.PaisCollection(),
					LibroFormatoEntity.Relations.LibroEntityUsingFormato,
					(int)ORMDiocesis.EntityType.LibroFormatoEntity, (int)ORMDiocesis.EntityType.PaisEntity, 0, null, null, relations, "PaisCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return LibroFormatoEntity.CustomProperties;}
		}
		...
		{
			get { return LibroFormatoEntity.FieldsCustomProperties;}
		}

		/// <summary> The Id property of the Entity LibroFormato<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BCatFormato"."Id"<br/>
		...
		public virtual System.Int32 Id
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)LibroFormatoFieldIndex.Id);
			...
			set	{ SetNewFieldValue((int)LibroFormatoFieldIndex.Id, value); }
		}
		/// <summary> The Formato property of the Entity LibroFormato<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BCatFormato"."Formato"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 100<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Formato
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)LibroFormatoFieldIndex.Formato);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)LibroFormatoFieldIndex.Formato, value); }
		}
		...
		/// <summary> Retrieves all related entities of type 'LibroEstatusEntity' using a relation of type 'm:n'.</summary>
		/// <remarks>This property is added for databinding conveniance, however it is recommeded to use the method 'GetMultiLibroEstatusCollectionViaLibro()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the same scope.</remarks>
		public virtual ORMDiocesis.CollectionClasses.LibroEstatusCollection LibroEstatusCollectionViaLibro
		{
			get { return GetMultiLibroEstatusCollectionViaLibro(false); }
		}

		/// <summary> Gets / sets the lazy loading flag for LibroEstatusCollectionViaLibro. When set to true, LibroEstatusCollectionViaLibro is always refetched from the 
		/// persistent storage. When set to false, the data is only fetched the first time LibroEstatusCollectionViaLibro is accessed. You can always execute
		/// a forced fetch by calling GetMultiLibroEstatusCollectionViaLibro(true).</summary>
		[Browsable(false)]
		public bool AlwaysFetchLibroEstatusCollectionViaLibro
		{
			get	{ return _alwaysFetchLibroEstatusCollectionViaLibro; }
			set	{ _alwaysFetchLibroEstatusCollectionViaLibro = value; }	
		}
		/// <summary> Retrieves all related entities of type 'RamaEntity' using a relation of type 'm:n'.</summary>
		...
		{ 
			get { return (int)ORMDiocesis.EntityType.LibroFormatoEntity; }
		}
		#endregion
