...
namespace ORMDiocesis.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'Autor'. <br/><br/>
	/// 
	/// </summary>
#if CF
	...
	[Serializable]
#endif
	public partial class AutorEntity : EntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for Autor which data should be fetched into this Autor object</param>
		public AutorEntity(System.Int32 id)
		{
		...
		public AutorEntity(System.Int32 id, IPrefetchPath prefetchPathToUse)
		{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for Autor which data should be fetched into this Autor object</param>
		/// <param name="validator">The custom validator object for this AutorEntity</param>
		public AutorEntity(System.Int32 id, IValidator validator)
		{
		...
		protected AutorEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		public bool TestOriginalFieldValueForNull(AutorFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(AutorFieldIndex fieldIndex)
		{
		...
		public virtual ORMDiocesis.CollectionClasses.LibroCollection GetMultiLibros(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedLibros || forceFetch || _alwaysFetchLibros) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				_libros.GetMultiManyToOne(this, null, null, null, null, null, null, null, filter);
		...
		public ORMDiocesis.CollectionClasses.LibroEstatusCollection GetMultiBcatEstatusCollectionViaLibro(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedBcatEstatusCollectionViaLibro || forceFetch || _alwaysFetchBcatEstatusCollectionViaLibro) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				relations.Add(AutorEntity.Relations.LibroEntityUsingIdAutor, "__AutorEntity__", "Libro_", JoinHint.None);
				relations.Add(LibroEntity.Relations.LibroEstatusEntityUsingEstatus, "Libro_", string.Empty, JoinHint.None);
				filter.Add(new FieldCompareValuePredicate(EntityFieldFactory.Create(AutorFieldIndex.Id), ComparisonOperator.Equal, this.Id));
		...
		public virtual PaisEntity GetSinglePais(bool forceFetch)
		{
			if( ( !_alreadyFetchedPais || forceFetch || _alwaysFetchPais) && !base.IsSerializing && !base.IsDeserializing )			
			{
				...
				if(base.CheckIfLazyLoadingShouldOccur(AutorEntity.Relations.PaisEntityUsingIdPais))
				{
		...
		protected override bool SetNewFieldValue(int fieldIndex, object value, bool checkForRefetch)
		{
			...
			if(toReturn && Enum.IsDefined(typeof(AutorFieldIndex), fieldIndex))
			{
				switch((AutorFieldIndex)fieldIndex)
				{
		...
		{
			AutorDAO dao = (AutorDAO)CreateDAOInstance();
		...
		/// <param name="id">PK value for Autor which data should be fetched into this Autor object</param>
		/// <param name="validator">The validator object for this AutorEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		private void InitClassMembers()
		{
			...
			_libros.SetContainingEntityInfo(this, "Autor");
		...
		{
			base.PerformDesetupSyncRelatedEntity( _pais, new PropertyChangedEventHandler( OnPaisPropertyChanged ), "Pais", AutorEntity.Relations.PaisEntityUsingIdPais, true, signalRelatedEntity, "Autores", resetFKFields, new int[] { (int)AutorFieldIndex.IdPais } );		
			_pais = null;
		}
		...
		private void SetupSyncPais(IEntity relatedEntity)
		{
			...
			base.PerformSetupSyncRelatedEntity( _pais, new PropertyChangedEventHandler( OnPaisPropertyChanged ), "Pais", AutorEntity.Relations.PaisEntityUsingIdPais, true, ref _alreadyFetchedPais, new string[] {  } );
		}
		...
		private bool Fetch(System.Int32 id, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			try
			{
				...
				base.Fields[(int)AutorFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		{
			return new AutorEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static AutorRelations Relations
		{
			get	{ return new AutorRelations(); }
		}
		...
		public static IPrefetchPathElement PrefetchPathLibros
		{
			get
			{
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroCollection(),
					AutorEntity.Relations.LibroEntityUsingIdAutor, 
					(int)ORMDiocesis.EntityType.AutorEntity, (int)ORMDiocesis.EntityType.LibroEntity, 0, null, null, null, "Libros", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathBcatEstatusCollectionViaLibro
		{
			...
			{
				IRelationCollection relations = new RelationCollection();
				relations.Add(AutorEntity.Relations.LibroEntityUsingIdAutor, "__AutorEntity__", string.Empty, JoinHint.None);
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroEstatusCollection(),
					AutorEntity.Relations.LibroEntityUsingIdAutor,
					(int)ORMDiocesis.EntityType.AutorEntity, (int)ORMDiocesis.EntityType.LibroEstatusEntity, 0, null, null, relations, "BcatEstatusCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathBcatFormatoCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroFormatoCollection(),
					AutorEntity.Relations.LibroEntityUsingIdAutor,
					(int)ORMDiocesis.EntityType.AutorEntity, (int)ORMDiocesis.EntityType.LibroFormatoEntity, 0, null, null, relations, "BcatFormatoCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathRamaCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.RamaCollection(),
					AutorEntity.Relations.LibroEntityUsingIdAutor,
					(int)ORMDiocesis.EntityType.AutorEntity, (int)ORMDiocesis.EntityType.RamaEntity, 0, null, null, relations, "RamaCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathSeccionCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.SeccionCollection(),
					AutorEntity.Relations.LibroEntityUsingIdAutor,
					(int)ORMDiocesis.EntityType.AutorEntity, (int)ORMDiocesis.EntityType.SeccionEntity, 0, null, null, relations, "SeccionCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathTematicaCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.TematicaCollection(),
					AutorEntity.Relations.LibroEntityUsingIdAutor,
					(int)ORMDiocesis.EntityType.AutorEntity, (int)ORMDiocesis.EntityType.TematicaEntity, 0, null, null, relations, "TematicaCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathPais
		{
			get
			{
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.PaisCollection(),
					AutorEntity.Relations.PaisEntityUsingIdPais, 
					(int)ORMDiocesis.EntityType.AutorEntity, (int)ORMDiocesis.EntityType.PaisEntity, 0, null, null, null, "Pais", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return AutorEntity.CustomProperties;}
		}
		...
		{
			get { return AutorEntity.FieldsCustomProperties;}
		}

		/// <summary> The Id property of the Entity Autor<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BCatAutores"."Id"<br/>
		...
		public virtual System.Int32 Id
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)AutorFieldIndex.Id);
			...
			set	{ SetNewFieldValue((int)AutorFieldIndex.Id, value); }
		}
		/// <summary> The Nombre property of the Entity Autor<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BCatAutores"."Nombre"<br/>
		...
		public virtual System.String Nombre
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)AutorFieldIndex.Nombre);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)AutorFieldIndex.Nombre, value); }
		}
		/// <summary> The IdPais property of the Entity Autor<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BCatAutores"."IdPais"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		...
		public virtual Nullable<System.Int32> IdPais
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)AutorFieldIndex.IdPais);

				return (Nullable<System.Int32>)valueToReturn;
			}
			set	{ SetNewFieldValue((int)AutorFieldIndex.IdPais, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_pais != null)
						{
							_pais.UnsetRelatedEntity(this, "Autores");
						}
					}
					else
					{
						((IEntity)value).SetRelatedEntity(this, "Autores");
					}
				}
			}
		}
		...
		{ 
			get { return (int)ORMDiocesis.EntityType.AutorEntity; }
		}
		#endregion
