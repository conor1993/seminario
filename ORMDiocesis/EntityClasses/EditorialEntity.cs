...
namespace ORMDiocesis.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'Editorial'. <br/><br/>
	/// 
	/// </summary>
#if CF
	...
	[Serializable]
#endif
	public partial class EditorialEntity : EntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for Editorial which data should be fetched into this Editorial object</param>
		public EditorialEntity(System.Int32 id)
		{
		...
		public EditorialEntity(System.Int32 id, IPrefetchPath prefetchPathToUse)
		{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for Editorial which data should be fetched into this Editorial object</param>
		/// <param name="validator">The custom validator object for this EditorialEntity</param>
		public EditorialEntity(System.Int32 id, IValidator validator)
		{
		...
		protected EditorialEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		public bool TestOriginalFieldValueForNull(EditorialFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(EditorialFieldIndex fieldIndex)
		{
		...
		public virtual ORMDiocesis.CollectionClasses.LibroCollection GetMultiLibros(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedLibros || forceFetch || _alwaysFetchLibros) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				_libros.GetMultiManyToOne(null, this, null, null, null, null, null, null, filter);
		...
		public ORMDiocesis.CollectionClasses.LibroEstatusCollection GetMultiBcatEstatusCollectionViaLibro(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedBcatEstatusCollectionViaLibro || forceFetch || _alwaysFetchBcatEstatusCollectionViaLibro) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				relations.Add(EditorialEntity.Relations.LibroEntityUsingIdEditorial, "__EditorialEntity__", "Libro_", JoinHint.None);
				relations.Add(LibroEntity.Relations.LibroEstatusEntityUsingEstatus, "Libro_", string.Empty, JoinHint.None);
				filter.Add(new FieldCompareValuePredicate(EntityFieldFactory.Create(EditorialFieldIndex.Id), ComparisonOperator.Equal, this.Id));
		...
		protected override bool SetNewFieldValue(int fieldIndex, object value, bool checkForRefetch)
		{
			...
			if(toReturn && Enum.IsDefined(typeof(EditorialFieldIndex), fieldIndex))
			{
				switch((EditorialFieldIndex)fieldIndex)
				{
					default:
						break;
				}
		...
		{
			EditorialDAO dao = (EditorialDAO)CreateDAOInstance();
		...
		/// <param name="id">PK value for Editorial which data should be fetched into this Editorial object</param>
		/// <param name="validator">The validator object for this EditorialEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		private void InitClassMembers()
		{
			...
			_libros.SetContainingEntityInfo(this, "Editorial");
		...
		private bool Fetch(System.Int32 id, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			try
			{
				...
				base.Fields[(int)EditorialFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		{
			return new EditorialEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static EditorialRelations Relations
		{
			get	{ return new EditorialRelations(); }
		}
		...
		public static IPrefetchPathElement PrefetchPathLibros
		{
			get
			{
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroCollection(),
					EditorialEntity.Relations.LibroEntityUsingIdEditorial, 
					(int)ORMDiocesis.EntityType.EditorialEntity, (int)ORMDiocesis.EntityType.LibroEntity, 0, null, null, null, "Libros", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathBcatEstatusCollectionViaLibro
		{
			...
			{
				IRelationCollection relations = new RelationCollection();
				relations.Add(EditorialEntity.Relations.LibroEntityUsingIdEditorial, "__EditorialEntity__", string.Empty, JoinHint.None);
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroEstatusCollection(),
					EditorialEntity.Relations.LibroEntityUsingIdEditorial,
					(int)ORMDiocesis.EntityType.EditorialEntity, (int)ORMDiocesis.EntityType.LibroEstatusEntity, 0, null, null, relations, "BcatEstatusCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathBcatFormatoCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroFormatoCollection(),
					EditorialEntity.Relations.LibroEntityUsingIdEditorial,
					(int)ORMDiocesis.EntityType.EditorialEntity, (int)ORMDiocesis.EntityType.LibroFormatoEntity, 0, null, null, relations, "BcatFormatoCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathRamaCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.RamaCollection(),
					EditorialEntity.Relations.LibroEntityUsingIdEditorial,
					(int)ORMDiocesis.EntityType.EditorialEntity, (int)ORMDiocesis.EntityType.RamaEntity, 0, null, null, relations, "RamaCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathSeccionCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.SeccionCollection(),
					EditorialEntity.Relations.LibroEntityUsingIdEditorial,
					(int)ORMDiocesis.EntityType.EditorialEntity, (int)ORMDiocesis.EntityType.SeccionEntity, 0, null, null, relations, "SeccionCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathTematicaCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.TematicaCollection(),
					EditorialEntity.Relations.LibroEntityUsingIdEditorial,
					(int)ORMDiocesis.EntityType.EditorialEntity, (int)ORMDiocesis.EntityType.TematicaEntity, 0, null, null, relations, "TematicaCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return EditorialEntity.CustomProperties;}
		}
		...
		{
			get { return EditorialEntity.FieldsCustomProperties;}
		}

		/// <summary> The Id property of the Entity Editorial<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BCatEditoriales"."Id"<br/>
		...
		public virtual System.Int32 Id
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)EditorialFieldIndex.Id);
			...
			set	{ SetNewFieldValue((int)EditorialFieldIndex.Id, value); }
		}
		/// <summary> The Nombre property of the Entity Editorial<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BCatEditoriales"."Nombre"<br/>
		...
		public virtual System.String Nombre
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)EditorialFieldIndex.Nombre);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)EditorialFieldIndex.Nombre, value); }
		}
		...
		{ 
			get { return (int)ORMDiocesis.EntityType.EditorialEntity; }
		}
		#endregion
