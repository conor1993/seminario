...
namespace ORMDiocesis.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the LibroFormato Entity. It will perform database oriented actions for
	/// a entity of type 'LibroFormatoEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class LibroFormatoDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public LibroFormatoDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "LibroFormatoEntity", new LibroFormatoEntityFactory())
		{
		}
		...
		internal LibroFormatoDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'LibroFormatoEntity' in a datatable which match the specified filter. 
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(ORMDiocesis.EntityType.LibroFormatoEntity);
		...
		/// <summary>
		/// Retrieves in the calling LibroFormatoCollection object all LibroFormatoEntity objects
		...
		public bool GetMultiUsingAutorCollectionViaLibro(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity autorInstance, int pageNumber, int pageSize)
		{
			...
			relations.Add(LibroFormatoEntity.Relations.LibroEntityUsingFormato, "Libro_");
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingLibroEstatusCollectionViaLibro(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity libroEstatusInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(ORMDiocesis.EntityType.LibroFormatoEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(LibroFormatoEntity.Relations.LibroEntityUsingFormato, "Libro_");
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingLibroEstatusCollectionViaLibro(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity libroEstatusInstance, IPrefetchPath prefetchPathToUse)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(ORMDiocesis.EntityType.LibroFormatoEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(LibroFormatoEntity.Relations.LibroEntityUsingFormato, "Libro_");
