...
namespace ORMDiocesis.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Seccion Entity. It will perform database oriented actions for
	/// a entity of type 'SeccionEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class SeccionDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public SeccionDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "SeccionEntity", new SeccionEntityFactory())
		{
		}
		...
		internal SeccionDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'SeccionEntity' in a datatable which match the specified filter. 
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(ORMDiocesis.EntityType.SeccionEntity);
		...
		/// <summary>
		/// Retrieves in the calling SeccionCollection object all SeccionEntity objects
		...
		public bool GetMultiUsingAutorCollectionViaLibro(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity autorInstance, int pageNumber, int pageSize)
		{
			...
			relations.Add(SeccionEntity.Relations.LibroEntityUsingIdSeccion, "Libro_");
