...
namespace ClasesNegocio
{
    ...
    #region Propiedades
        ...
        [System.ComponentModel.DisplayName("ID Formato")]
        public int? Formato
        {
        ...
        [System.ComponentModel.DisplayName("ID Estatus")]
        public int? Estatus
        {
    ...
    public class LibroCol : CN.ColleccionBase<EC.LibroEntity, CC.LibroCollection, CN.Libro>
    {
        ...
        public int Obtener(Libro elem)
        {
            try
            {
                ...
                Filtro.AddWithOr(HC.LibroFields.Isbn == elem.ISBN);
        ...
        public int Obtener(String isbn)
        {
            try
            {
                this.ClearItems();
                Filtro = new SD.LLBLGen.Pro.ORMSupportClasses.PredicateExpression();
                Filtro.AddWithOr(HC.LibroFields.Isbn == isbn);
                int Conteo = Coleccion.GetDbCount(Filtro);
                if (Conteo > 0)
                {
                    Coleccion.GetMulti(Filtro);
        ...
        public int Obtener(String titulo,int autor,int editorial)
        {
            try
            {
                this.ClearItems();
                Filtro = new SD.LLBLGen.Pro.ORMSupportClasses.PredicateExpression();
                Filtro.AddWithAnd(HC.LibroFields.Titulo == titulo);
                Filtro.AddWithAnd(HC.LibroFields.IdAutor == autor);
                Filtro.AddWithAnd(HC.LibroFields.IdEditorial == editorial);
                int Conteo = Coleccion.GetDbCount(Filtro);
                if (Conteo > 0)
                {
                    Coleccion.GetMulti(Filtro);
