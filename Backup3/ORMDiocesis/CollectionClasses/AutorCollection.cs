...
namespace ORMDiocesis.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of AutorEntity objects. </summary>
#if CF
	[SD.LLBLGen.Pro.ORMSupportClasses.Serializable]
#else
	[Serializable]
#endif
	public partial class AutorCollection : EntityCollectionBase<AutorEntity>
	{
		/// <summary> CTor</summary>
		public AutorCollection():base(new AutorEntityFactory())
		{
		}

		/// <summary> CTor</summary>
		/// <param name="initialContents">The initial contents of this collection.</param>
		public AutorCollection(IList<AutorEntity> initialContents):base(new AutorEntityFactory())
		{
		}

		/// <summary> CTor</summary>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public AutorCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected AutorCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}


		/// <summary> Retrieves in this AutorCollection object all AutorEntity objects which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter. All current elements in the collection are removed from the collection.</summary>
		/// <param name="paisInstance">PaisEntity instance to use as a filter for the AutorEntity objects to return</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity paisInstance)
		{
			return GetMultiManyToOne(paisInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity paisInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(paisInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter, 0, 0);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity paisInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			return GetMultiManyToOne(paisInstance, maxNumberOfItemsToReturn, sortClauses, filter, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToOne(IEntity paisInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			...
			AutorDAO dao = DAOFactory.CreateAutorDAO();
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, filter, paisInstance, pageNumber, pageSize);
		}

		/// <summary> Deletes from the persistent storage all Autor entities which have data in common with the specified related Entities. If one is omitted, that entity is not used as a filter.</summary>
		/// <remarks>Runs directly on the persistent storage. It will not delete entity objects from the current collection.</remarks>
		/// <param name="paisInstance">PaisEntity instance to use as a filter for the AutorEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMultiManyToOne(IEntity paisInstance)
		{
			AutorDAO dao = DAOFactory.CreateAutorDAO();
			return dao.DeleteMulti(base.Transaction, paisInstance);
		}

		/// <summary> Updates in the persistent storage all Autor entities which have data in common with the specified related Entities. If one is omitted, that entity is not used as a filter.
		/// Which fields are updated in those matching entities depends on which fields are <i>changed</i> in the passed in entity entityWithNewValues. The new values of these fields are read from entityWithNewValues. </summary>
		/// <param name="entityWithNewValues">AutorEntity instance which holds the new values for the matching entities to update. Only changed fields are taken into account</param>
		/// <param name="paisInstance">PaisEntity instance to use as a filter for the AutorEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(AutorEntity entityWithNewValues, IEntity paisInstance)
		{
			AutorDAO dao = DAOFactory.CreateAutorDAO();
			return dao.UpdateMulti(entityWithNewValues, base.Transaction, paisInstance);
		}

		/// <summary> Retrieves in this AutorCollection object all AutorEntity objects which are related via a  Relation of type 'm:n' with the passed in LibroEstatusEntity. 
		...
		/// <summary> Retrieves in this AutorCollection object all AutorEntity objects which are related via a  Relation of type 'm:n' with the passed in LibroFormatoEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this AutorCollection object all AutorEntity objects which are related via a  Relation of type 'm:n' with the passed in RamaEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this AutorCollection object all AutorEntity objects which are related via a  Relation of type 'm:n' with the passed in SeccionEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this AutorCollection object all AutorEntity objects which are related via a  Relation of type 'm:n' with the passed in TematicaEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Deletes from the persistent storage all Autor entities which match with the specified filter, formulated in the predicate or predicate expression definition.</summary>
		/// <param name="deleteFilter">A predicate or predicate expression which should be used as filter for the entities to delete. Can be null, which will result in a query removing all Autor entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary> Updates in the persistent storage all entities which have data in common with the specified AutorEntity. If one is omitted that entity is not used as a filter. Which fields are updated in those matching entities depends on which fields are
		...
		/// will result in an update action which will affect all Autor entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(AutorEntity entityWithNewValues, IPredicate updateFilter)
		{
			AutorDAO dao = DAOFactory.CreateAutorDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(AutorEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			AutorDAO dao = DAOFactory.CreateAutorDAO();
		...
		public object GetScalar(AutorFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(AutorFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(AutorFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(AutorFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(AutorFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
		...
		{
			return DAOFactory.CreateAutorDAO();
		}
