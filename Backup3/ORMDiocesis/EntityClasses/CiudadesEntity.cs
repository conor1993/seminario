...
namespace ORMDiocesis.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'Ciudades'. <br/><br/>
	/// 
	/// </summary>
#if CF
	...
	[Serializable]
#endif
	public partial class CiudadesEntity : EntityBase, ISerializable
			...
			
	{
		...
		protected CiudadesEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		public bool TestOriginalFieldValueForNull(CiudadesFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(CiudadesFieldIndex fieldIndex)
		{
		...
		protected override bool SetNewFieldValue(int fieldIndex, object value, bool checkForRefetch)
		{
			...
			if(toReturn && Enum.IsDefined(typeof(CiudadesFieldIndex), fieldIndex))
			{
				switch((CiudadesFieldIndex)fieldIndex)
				{
					default:
						break;
				}
		...
		{
			CiudadesDAO dao = (CiudadesDAO)CreateDAOInstance();
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("Nomciudad", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			return new CiudadesEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static CiudadesRelations Relations
		{
			get	{ return new CiudadesRelations(); }
		}
		...
		{
			get { return CiudadesEntity.CustomProperties;}
		}
		...
		{
			get { return CiudadesEntity.FieldsCustomProperties;}
		}

		/// <summary> The Nomciudad property of the Entity Ciudades<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  view field: "Ciudades"."Nomciudad"<br/>
		...
		public virtual System.String Nomciudad
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)CiudadesFieldIndex.Nomciudad);
			...
			set	{ SetNewFieldValue((int)CiudadesFieldIndex.Nomciudad, value); }
		}
		/// <summary> The Idciudad property of the Entity Ciudades<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  view field: "Ciudades"."Idciudad"<br/>
		...
		public virtual System.Byte Idciudad
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)CiudadesFieldIndex.Idciudad);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)CiudadesFieldIndex.Idciudad, value); }
		}
		...
		{ 
			get { return (int)ORMDiocesis.EntityType.CiudadesEntity; }
		}
		#endregion
