...
namespace ORMDiocesis.EntityClasses
{
			...
			
	{
		...
		private LibroEstatusEntity _bcatEstatus;
		private bool	_alwaysFetchBcatEstatus, _alreadyFetchedBcatEstatus, _bcatEstatusReturnsNewIfNotFound;
		private LibroFormatoEntity _bcatFormato;
		private bool	_alwaysFetchBcatFormato, _alreadyFetchedBcatFormato, _bcatFormatoReturnsNewIfNotFound;
		...
		protected LibroEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			_bcatEstatus = (LibroEstatusEntity)info.GetValue("_bcatEstatus", typeof(LibroEstatusEntity));
			if(_bcatEstatus!=null)
			{
				_bcatEstatus.AfterSave+=new EventHandler(OnEntityAfterSave);
			}
			_bcatEstatusReturnsNewIfNotFound = info.GetBoolean("_bcatEstatusReturnsNewIfNotFound");
			_alwaysFetchBcatEstatus = info.GetBoolean("_alwaysFetchBcatEstatus");
			_alreadyFetchedBcatEstatus = info.GetBoolean("_alreadyFetchedBcatEstatus");
			_bcatFormato = (LibroFormatoEntity)info.GetValue("_bcatFormato", typeof(LibroFormatoEntity));
			if(_bcatFormato!=null)
			{
				_bcatFormato.AfterSave+=new EventHandler(OnEntityAfterSave);
			}
			_bcatFormatoReturnsNewIfNotFound = info.GetBoolean("_bcatFormatoReturnsNewIfNotFound");
			_alwaysFetchBcatFormato = info.GetBoolean("_alwaysFetchBcatFormato");
			_alreadyFetchedBcatFormato = info.GetBoolean("_alreadyFetchedBcatFormato");
		...
		protected override void PostReadXmlFixups()
		{
			...
			_alreadyFetchedBcatEstatus = (_bcatEstatus != null);
			_alreadyFetchedBcatFormato = (_bcatFormato != null);
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue("_bcatEstatus", _bcatEstatus);
			info.AddValue("_bcatEstatusReturnsNewIfNotFound", _bcatEstatusReturnsNewIfNotFound);
			info.AddValue("_alwaysFetchBcatEstatus", _alwaysFetchBcatEstatus);
			info.AddValue("_alreadyFetchedBcatEstatus", _alreadyFetchedBcatEstatus);
			info.AddValue("_bcatFormato", _bcatFormato);
			info.AddValue("_bcatFormatoReturnsNewIfNotFound", _bcatFormatoReturnsNewIfNotFound);
			info.AddValue("_alwaysFetchBcatFormato", _alwaysFetchBcatFormato);
			info.AddValue("_alreadyFetchedBcatFormato", _alreadyFetchedBcatFormato);
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity entity)
		{
			switch(propertyName)
			{
				...
				case "Editorial":
					...
					break;
				case "BcatEstatus":
					_alreadyFetchedBcatEstatus = true;
					this.BcatEstatus = (LibroEstatusEntity)entity;
					break;
				case "BcatFormato":
					_alreadyFetchedBcatFormato = true;
					this.BcatFormato = (LibroFormatoEntity)entity;
					break;
				case "Rama":
		...
		public override void SetRelatedEntity(IEntity relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				...
				case "Editorial":
					...
					break;
				case "BcatEstatus":
					SetupSyncBcatEstatus(relatedEntity);
					OnRelatedEntitySet(relatedEntity, fieldName);
					break;
				case "BcatFormato":
					SetupSyncBcatFormato(relatedEntity);
					OnRelatedEntitySet(relatedEntity, fieldName);
					break;
				case "Rama":
		...
		public override void UnsetRelatedEntity(IEntity relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				...
				case "Editorial":
					...
					break;
				case "BcatEstatus":
					DesetupSyncBcatEstatus(false, true);
					OnRelatedEntityUnset(relatedEntity, fieldName);
					break;
				case "BcatFormato":
					DesetupSyncBcatFormato(false, true);
					OnRelatedEntityUnset(relatedEntity, fieldName);
					break;
				case "Rama":
		...
		public override List<IEntity> GetDependentRelatedEntities()
		{
			...
			if(_bcatEstatus!=null)
			{
				toReturn.Add(_bcatEstatus);
			}
			if(_bcatFormato!=null)
			{
				toReturn.Add(_bcatFormato);
			}
			if(_rama!=null)
			{
				toReturn.Add(_rama);
		...
		/// <summary> Retrieves the related entity of type 'LibroEstatusEntity', using a relation of type 'n:1'</summary>
		/// <returns>A fetched entity of type 'LibroEstatusEntity' which is related to this entity.</returns>
		public LibroEstatusEntity GetSingleBcatEstatus()
		{
			return GetSingleBcatEstatus(false);
		}

		/// <summary> Retrieves the related entity of type 'LibroEstatusEntity', using a relation of type 'n:1'</summary>
		/// <param name="forceFetch">if true, it will discard any changes currently in the currently loaded related entity and will refetch the entity from the persistent storage</param>
		/// <returns>A fetched entity of type 'LibroEstatusEntity' which is related to this entity.</returns>
		public virtual LibroEstatusEntity GetSingleBcatEstatus(bool forceFetch)
		{
			if( ( !_alreadyFetchedBcatEstatus || forceFetch || _alwaysFetchBcatEstatus) && !base.IsSerializing && !base.IsDeserializing )			
			{

				LibroEstatusEntity newEntity = new LibroEstatusEntity();
				if(base.ParticipatesInTransaction)
				{
					base.Transaction.Add(newEntity);
				}
				bool fetchResult = false;
				if(base.CheckIfLazyLoadingShouldOccur(LibroEntity.Relations.LibroEstatusEntityUsingEstatus))
				{
					fetchResult = newEntity.FetchUsingPK(this.Estatus.GetValueOrDefault());
				}
				if(!_bcatEstatusReturnsNewIfNotFound && !fetchResult)
				{
					this.BcatEstatus = null;
				}
				else
				{
					if((base.ActiveContext!=null)&&fetchResult)
					{
						newEntity = (LibroEstatusEntity)base.ActiveContext.Get(newEntity);
					}
					this.BcatEstatus = newEntity;
					_alreadyFetchedBcatEstatus = fetchResult;
				}
				if(base.ParticipatesInTransaction && !fetchResult)
				{
					base.Transaction.Remove(newEntity);
		...
		/// <summary> Retrieves the related entity of type 'LibroFormatoEntity', using a relation of type 'n:1'</summary>
		/// <returns>A fetched entity of type 'LibroFormatoEntity' which is related to this entity.</returns>
		public LibroFormatoEntity GetSingleBcatFormato()
		{
			return GetSingleBcatFormato(false);
		}

		/// <summary> Retrieves the related entity of type 'LibroFormatoEntity', using a relation of type 'n:1'</summary>
		/// <param name="forceFetch">if true, it will discard any changes currently in the currently loaded related entity and will refetch the entity from the persistent storage</param>
		/// <returns>A fetched entity of type 'LibroFormatoEntity' which is related to this entity.</returns>
		public virtual LibroFormatoEntity GetSingleBcatFormato(bool forceFetch)
		{
			if( ( !_alreadyFetchedBcatFormato || forceFetch || _alwaysFetchBcatFormato) && !base.IsSerializing && !base.IsDeserializing )			
			{

				LibroFormatoEntity newEntity = new LibroFormatoEntity();
				if(base.ParticipatesInTransaction)
				{
					base.Transaction.Add(newEntity);
				}
				bool fetchResult = false;
				if(base.CheckIfLazyLoadingShouldOccur(LibroEntity.Relations.LibroFormatoEntityUsingFormato))
				{
					fetchResult = newEntity.FetchUsingPK(this.Formato.GetValueOrDefault());
				}
				if(!_bcatFormatoReturnsNewIfNotFound && !fetchResult)
				{
					this.BcatFormato = null;
				}
				else
				{
					if((base.ActiveContext!=null)&&fetchResult)
					{
						newEntity = (LibroFormatoEntity)base.ActiveContext.Get(newEntity);
					}
					this.BcatFormato = newEntity;
					_alreadyFetchedBcatFormato = fetchResult;
				}
				if(base.ParticipatesInTransaction && !fetchResult)
				{
					base.Transaction.Remove(newEntity);
			...
			if(toReturn && Enum.IsDefined(typeof(LibroFieldIndex), fieldIndex))
			{
				switch((LibroFieldIndex)fieldIndex)
				{
					...
					case LibroFieldIndex.IdPais:
						...
						break;
					case LibroFieldIndex.Formato:
						DesetupSyncBcatFormato(true, false);
						_alreadyFetchedBcatFormato = false;
						break;
					case LibroFieldIndex.Estatus:
						DesetupSyncBcatEstatus(true, false);
						_alreadyFetchedBcatEstatus = false;
						break;
					default:
						break;
				}
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_bcatEstatus!=null)
			{
				_bcatEstatus.ActiveContext = base.ActiveContext;
			}
			if(_bcatFormato!=null)
			{
				_bcatFormato.ActiveContext = base.ActiveContext;
			}
			if(_rama!=null)
			{
		...
		private void InitClassMembers()
		{
			...
			_alreadyFetchedEditorial = false;
			_bcatEstatus = null;
			_bcatEstatusReturnsNewIfNotFound = true;
			_alwaysFetchBcatEstatus = false;
			_alreadyFetchedBcatEstatus = false;
			_bcatFormato = null;
			_bcatFormatoReturnsNewIfNotFound = true;
			_alwaysFetchBcatFormato = false;
			_alreadyFetchedBcatFormato = false;
			_rama = null;
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("Portada", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("ContraPortada", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("Materia", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("Formato", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <summary> Removes the sync logic for member _bcatEstatus</summary>
		/// <param name="signalRelatedEntity">If set to true, it will call the related entity's UnsetRelatedEntity method</param>
		/// <param name="resetFKFields">if set to true it will also reset the FK fields pointing to the related entity</param>
		private void DesetupSyncBcatEstatus(bool signalRelatedEntity, bool resetFKFields)
		{
			base.PerformDesetupSyncRelatedEntity( _bcatEstatus, new PropertyChangedEventHandler( OnBcatEstatusPropertyChanged ), "BcatEstatus", LibroEntity.Relations.LibroEstatusEntityUsingEstatus, true, signalRelatedEntity, "Libro", resetFKFields, new int[] { (int)LibroFieldIndex.Estatus } );		
			_bcatEstatus = null;
		}
		
		/// <summary> setups the sync logic for member _bcatEstatus</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncBcatEstatus(IEntity relatedEntity)
		{
			DesetupSyncBcatEstatus(true, true);
			_bcatEstatus = (LibroEstatusEntity)relatedEntity;
			base.PerformSetupSyncRelatedEntity( _bcatEstatus, new PropertyChangedEventHandler( OnBcatEstatusPropertyChanged ), "BcatEstatus", LibroEntity.Relations.LibroEstatusEntityUsingEstatus, true, ref _alreadyFetchedBcatEstatus, new string[] {  } );
		}

		/// <summary>Handles property change events of properties in a related entity.</summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void OnBcatEstatusPropertyChanged( object sender, PropertyChangedEventArgs e )
		{
			switch( e.PropertyName )
			{
				default:
		...
		/// <summary> Removes the sync logic for member _bcatFormato</summary>
		/// <param name="signalRelatedEntity">If set to true, it will call the related entity's UnsetRelatedEntity method</param>
		/// <param name="resetFKFields">if set to true it will also reset the FK fields pointing to the related entity</param>
		private void DesetupSyncBcatFormato(bool signalRelatedEntity, bool resetFKFields)
		{
			base.PerformDesetupSyncRelatedEntity( _bcatFormato, new PropertyChangedEventHandler( OnBcatFormatoPropertyChanged ), "BcatFormato", LibroEntity.Relations.LibroFormatoEntityUsingFormato, true, signalRelatedEntity, "Libro", resetFKFields, new int[] { (int)LibroFieldIndex.Formato } );		
			_bcatFormato = null;
		}
		
		/// <summary> setups the sync logic for member _bcatFormato</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncBcatFormato(IEntity relatedEntity)
		{
			DesetupSyncBcatFormato(true, true);
			_bcatFormato = (LibroFormatoEntity)relatedEntity;
			base.PerformSetupSyncRelatedEntity( _bcatFormato, new PropertyChangedEventHandler( OnBcatFormatoPropertyChanged ), "BcatFormato", LibroEntity.Relations.LibroFormatoEntityUsingFormato, true, ref _alreadyFetchedBcatFormato, new string[] {  } );
		}

		/// <summary>Handles property change events of properties in a related entity.</summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void OnBcatFormatoPropertyChanged( object sender, PropertyChangedEventArgs e )
		{
			switch( e.PropertyName )
			{
				default:
		...
		{
			base.PerformDesetupSyncRelatedEntity( _rama, new PropertyChangedEventHandler( OnRamaPropertyChanged ), "Rama", LibroEntity.Relations.RamaEntityUsingIdRama, true, signalRelatedEntity, "Libro", resetFKFields, new int[] { (int)LibroFieldIndex.IdRama } );		
			_rama = null;
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _seccion, new PropertyChangedEventHandler( OnSeccionPropertyChanged ), "Seccion", LibroEntity.Relations.SeccionEntityUsingIdSeccion, true, signalRelatedEntity, "Libro", resetFKFields, new int[] { (int)LibroFieldIndex.IdSeccion } );		
			_seccion = null;
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _tematica, new PropertyChangedEventHandler( OnTematicaPropertyChanged ), "Tematica", LibroEntity.Relations.TematicaEntityUsingIdTematica, true, signalRelatedEntity, "Libro", resetFKFields, new int[] { (int)LibroFieldIndex.IdTematica } );		
			_tematica = null;
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathBcatEstatus
		{
			get
			{
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroEstatusCollection(),
					LibroEntity.Relations.LibroEstatusEntityUsingEstatus, 
					(int)ORMDiocesis.EntityType.LibroEntity, (int)ORMDiocesis.EntityType.LibroEstatusEntity, 0, null, null, null, "BcatEstatus", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathBcatFormato
		{
			get
			{
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroFormatoCollection(),
					LibroEntity.Relations.LibroFormatoEntityUsingFormato, 
					(int)ORMDiocesis.EntityType.LibroEntity, (int)ORMDiocesis.EntityType.LibroFormatoEntity, 0, null, null, null, "BcatFormato", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Pasillo
		{
			get
			{
		...
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Estante
		{
			get
			{
		...
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Nivel
		{
			get
			{
		...
		/// <summary> The Portada property of the Entity Libro<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BInvLibros"."Portada"<br/>
		/// Table field type characteristics (type, precision, scale, length): Image, 0, 0, 2147483647<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.Byte[] Portada
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)LibroFieldIndex.Portada);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)LibroFieldIndex.Portada, value); }
		}
		/// <summary> The ContraPortada property of the Entity Libro<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BInvLibros"."ContraPortada"<br/>
		/// Table field type characteristics (type, precision, scale, length): Image, 0, 0, 2147483647<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.Byte[] ContraPortada
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)LibroFieldIndex.ContraPortada);
				if(valueToReturn == null)
				{
					valueToReturn = TypeDefaultValue.GetDefaultValue(typeof(System.Byte[]));
				}
			...
			set	{ SetNewFieldValue((int)LibroFieldIndex.ContraPortada, value); }
		}
		/// <summary> The Materia property of the Entity Libro<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BInvLibros"."Materia"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 200<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Materia
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)LibroFieldIndex.Materia);
				if(valueToReturn == null)
				{
					valueToReturn = TypeDefaultValue.GetDefaultValue(typeof(System.String));
				}
			...
			set	{ SetNewFieldValue((int)LibroFieldIndex.Materia, value); }
		}
		/// <summary> The Formato property of the Entity Libro<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BInvLibros"."Formato"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int32> Formato
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)LibroFieldIndex.Formato);

				return (Nullable<System.Int32>)valueToReturn;
			}
			set	{ SetNewFieldValue((int)LibroFieldIndex.Formato, value); }
		}
		/// <summary> The Estatus property of the Entity Libro<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BInvLibros"."Estatus"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int32> Estatus
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)LibroFieldIndex.Estatus);

				return (Nullable<System.Int32>)valueToReturn;
			}
			set	{ SetNewFieldValue((int)LibroFieldIndex.Estatus, value); }
		}
		/// <summary> The Numero property of the Entity Libro<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BInvLibros"."numero"<br/>
		...
		public virtual System.String Numero
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)LibroFieldIndex.Numero);
				if(valueToReturn == null)
				{
					valueToReturn = TypeDefaultValue.GetDefaultValue(typeof(System.String));
				}
			...
			set	{ SetNewFieldValue((int)LibroFieldIndex.Numero, value); }
		}
		...
		/// <summary> Gets / sets related entity of type 'LibroEstatusEntity'. This property is not visible in databound grids.
		/// Setting this property to a new object will make the load-on-demand feature to stop fetching data from the database, until you set this
		/// property to null. Setting this property to an entity will make sure that FK-PK relations are synchronized when appropriate.</summary>
		/// <remarks>This property is added for conveniance, however it is recommeded to use the method 'GetSingleBcatEstatus()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the
		/// same scope. The property is marked non-browsable to make it hidden in bound controls, f.e. datagrids.</remarks>
		[Browsable(false)]
		public virtual LibroEstatusEntity BcatEstatus
		{
			get	{ return GetSingleBcatEstatus(false); }
			set
			{
				if(base.IsDeserializing)
				{
					SetupSyncBcatEstatus(value);
				}
				else
				{
					if(value==null)
					{
						if(_bcatEstatus != null)
						{
							_bcatEstatus.UnsetRelatedEntity(this, "Libro");
						}
					}
					else
					{
						((IEntity)value).SetRelatedEntity(this, "Libro");
					}
				}
			}
		}

		/// <summary> Gets / sets the lazy loading flag for BcatEstatus. When set to true, BcatEstatus is always refetched from the 
		/// persistent storage. When set to false, the data is only fetched the first time BcatEstatus is accessed. You can always execute
		/// a forced fetch by calling GetSingleBcatEstatus(true).</summary>
		[Browsable(false)]
		public bool AlwaysFetchBcatEstatus
		{
			get	{ return _alwaysFetchBcatEstatus; }
			set	{ _alwaysFetchBcatEstatus = value; }	
		}
		
		/// <summary> Gets / sets the flag for what to do if the related entity available through the property BcatEstatus is not found
		/// in the database. When set to true, BcatEstatus will return a new entity instance if the related entity is not found, otherwise 
		/// null be returned if the related entity is not found. Default: true.</summary>
		[Browsable(false)]
		public bool BcatEstatusReturnsNewIfNotFound
		{
			get	{ return _bcatEstatusReturnsNewIfNotFound; }
			set { _bcatEstatusReturnsNewIfNotFound = value; }	
		}
		/// <summary> Gets / sets related entity of type 'LibroFormatoEntity'. This property is not visible in databound grids.
		/// Setting this property to a new object will make the load-on-demand feature to stop fetching data from the database, until you set this
		/// property to null. Setting this property to an entity will make sure that FK-PK relations are synchronized when appropriate.</summary>
		/// <remarks>This property is added for conveniance, however it is recommeded to use the method 'GetSingleBcatFormato()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the
		/// same scope. The property is marked non-browsable to make it hidden in bound controls, f.e. datagrids.</remarks>
		[Browsable(false)]
		public virtual LibroFormatoEntity BcatFormato
		{
			get	{ return GetSingleBcatFormato(false); }
			set
			{
				if(base.IsDeserializing)
				{
					SetupSyncBcatFormato(value);
				}
				else
				{
					if(value==null)
					{
						if(_bcatFormato != null)
						{
							_bcatFormato.UnsetRelatedEntity(this, "Libro");
						}
					}
					else
					{
		...
		/// <summary> Gets / sets the lazy loading flag for BcatFormato. When set to true, BcatFormato is always refetched from the 
		/// persistent storage. When set to false, the data is only fetched the first time BcatFormato is accessed. You can always execute
		/// a forced fetch by calling GetSingleBcatFormato(true).</summary>
		[Browsable(false)]
		public bool AlwaysFetchBcatFormato
		{
			get	{ return _alwaysFetchBcatFormato; }
			set	{ _alwaysFetchBcatFormato = value; }	
		}
		
		/// <summary> Gets / sets the flag for what to do if the related entity available through the property BcatFormato is not found
		/// in the database. When set to true, BcatFormato will return a new entity instance if the related entity is not found, otherwise 
		/// null be returned if the related entity is not found. Default: true.</summary>
		[Browsable(false)]
		public bool BcatFormatoReturnsNewIfNotFound
		{
			get	{ return _bcatFormatoReturnsNewIfNotFound; }
			set { _bcatFormatoReturnsNewIfNotFound = value; }	
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_rama != null)
						{
							_rama.UnsetRelatedEntity(this, "Libro");
						}
					}
					else
					{
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_seccion != null)
						{
							_seccion.UnsetRelatedEntity(this, "Libro");
						}
					}
					else
					{
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_tematica != null)
						{
							_tematica.UnsetRelatedEntity(this, "Libro");
						}
					}
					else
					{
