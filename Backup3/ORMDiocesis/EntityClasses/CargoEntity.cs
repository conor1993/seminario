...
namespace ORMDiocesis.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'Cargo'. <br/><br/>
	/// 
	/// </summary>
#if CF
	...
	[Serializable]
#endif
	public partial class CargoEntity : EntityBase, ISerializable
			...
			
	{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for Cargo which data should be fetched into this Cargo object</param>
		public CargoEntity(System.Int32 id)
		{
		...
		public CargoEntity(System.Int32 id, IPrefetchPath prefetchPathToUse)
		{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for Cargo which data should be fetched into this Cargo object</param>
		/// <param name="validator">The custom validator object for this CargoEntity</param>
		public CargoEntity(System.Int32 id, IValidator validator)
		{
		...
		protected CargoEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		public bool TestOriginalFieldValueForNull(CargoFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(CargoFieldIndex fieldIndex)
		{
		...
		protected override bool SetNewFieldValue(int fieldIndex, object value, bool checkForRefetch)
		{
			...
			if(toReturn && Enum.IsDefined(typeof(CargoFieldIndex), fieldIndex))
			{
				switch((CargoFieldIndex)fieldIndex)
				{
					default:
						break;
				}
		...
		{
			CargoDAO dao = (CargoDAO)CreateDAOInstance();
		...
		/// <param name="id">PK value for Cargo which data should be fetched into this Cargo object</param>
		/// <param name="validator">The validator object for this CargoEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		private bool Fetch(System.Int32 id, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			try
			{
				...
				base.Fields[(int)CargoFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		{
			return new CargoEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static CargoRelations Relations
		{
			get	{ return new CargoRelations(); }
		}
		...
		{
			get { return CargoEntity.CustomProperties;}
		}
		...
		{
			get { return CargoEntity.FieldsCustomProperties;}
		}

		/// <summary> The Id property of the Entity Cargo<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "CatCargo"."id"<br/>
		...
		public virtual System.Int32 Id
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)CargoFieldIndex.Id);
			...
			set	{ SetNewFieldValue((int)CargoFieldIndex.Id, value); }
		}
		/// <summary> The Cargo property of the Entity Cargo<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "CatCargo"."Cargo"<br/>
		...
		public virtual System.String Cargo
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)CargoFieldIndex.Cargo);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)CargoFieldIndex.Cargo, value); }
		}
		...
		{ 
			get { return (int)ORMDiocesis.EntityType.CargoEntity; }
		}
		#endregion
