...
{
    public partial class frmCatCuentascobro : Form, CN.iForm
    {
        ...
        private void frmCatCuentascobro_Load(object sender, EventArgs e)
        {
            llenarGrid();
        }
        ...
        public void Guardar()
        {
            ...
            try
            {
                ...
                _SQLComm.CommandText = "GuardarCuentacobro";
        ...
        private void dgvprogramas_DoubleClick(object sender, EventArgs e)
        {
            if (dgvprogramas.SelectedRows.Count > 0)
            {
                ...
                String cons = "select * from SortCatCuentacobro where id = " + id;
        ...
        private void llenarGrid()
        {
            ...
            cons = "select * from SortCatCuentacobro ";
            DtAdap.SelectCommand = new SqlCommand(cons, CN.DBU.Cnn);
            DtAdap.Fill(dtsPar);
            DtAdap = null;
