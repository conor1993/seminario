...
{
    public partial class frmCatprogramas : Form, CN.iForm
    {
        ...
        public frmCatprogramas()
        {
            InitializeComponent();
        }

        private void frmCatprogramas_Load(object sender, EventArgs e)
        {
            llenarGrid();
        }
        ...
        public void Guardar()
        {
            ...
            try
            {
                ...
                _SQLComm.CommandText = "GuardarPrograma";
        ...
        private void dgvprogramas_DoubleClick(object sender, EventArgs e)
        {
            if (dgvprogramas.SelectedRows.Count > 0)
            {
                ...
                String cons = "select * from SortCatProgramas where id = " + id;
        ...
        private void llenarGrid()
        {
            ...
            cons = "select * from SortCatProgramas";
            DtAdap.SelectCommand = new SqlCommand(cons, CN.DBU.Cnn);
            DtAdap.Fill(dtsPar);
            DtAdap = null;
