...
{
    public partial class frmCatEquipos : Form, CN.iForm
    {
        ...
        private void frmCatEquipos_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void frmCatEquipos_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void frmCatEquipos_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void DataGrid_DoubleClick(object sender, EventArgs e)
        {
            ...
            try
            {
                if (DataGrid.SelectedRows.Count > 0)
                {
                    ...
                    if (Evento.Obtener(DataGrid.SelectedRows[0].Cells[0].Value))
                    {
