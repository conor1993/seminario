...
namespace ORMDiocesis.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'TipoParroquia'. <br/><br/>
	/// 
	/// </summary>
#if CF
	...
	[Serializable]
#endif
	public partial class TipoParroquiaEntity : EntityBase, ISerializable
			...
			
	{
		...
		private ORMDiocesis.CollectionClasses.ZonaPastoralCollection _catZonaPastoralCollectionViaCatParroquias;
		private bool	_alwaysFetchCatZonaPastoralCollectionViaCatParroquias, _alreadyFetchedCatZonaPastoralCollectionViaCatParroquias;
		...
		static TipoParroquiaEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public TipoParroquiaEntity()
		{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for TipoParroquia which data should be fetched into this TipoParroquia object</param>
		public TipoParroquiaEntity(System.Byte id)
		{
		...
		public TipoParroquiaEntity(System.Byte id, IPrefetchPath prefetchPathToUse)
		{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for TipoParroquia which data should be fetched into this TipoParroquia object</param>
		/// <param name="validator">The custom validator object for this TipoParroquiaEntity</param>
		public TipoParroquiaEntity(System.Byte id, IValidator validator)
		{
		...
		protected TipoParroquiaEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			_catZonaPastoralCollectionViaCatParroquias = (ORMDiocesis.CollectionClasses.ZonaPastoralCollection)info.GetValue("_catZonaPastoralCollectionViaCatParroquias", typeof(ORMDiocesis.CollectionClasses.ZonaPastoralCollection));
			_alwaysFetchCatZonaPastoralCollectionViaCatParroquias = info.GetBoolean("_alwaysFetchCatZonaPastoralCollectionViaCatParroquias");
			_alreadyFetchedCatZonaPastoralCollectionViaCatParroquias = info.GetBoolean("_alreadyFetchedCatZonaPastoralCollectionViaCatParroquias");
		...
		protected override void PostReadXmlFixups()
		{
			...
			_alreadyFetchedCatZonaPastoralCollectionViaCatParroquias = (_catZonaPastoralCollectionViaCatParroquias.Count > 0);
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue("_catZonaPastoralCollectionViaCatParroquias", _catZonaPastoralCollectionViaCatParroquias);
			info.AddValue("_alwaysFetchCatZonaPastoralCollectionViaCatParroquias", _alwaysFetchCatZonaPastoralCollectionViaCatParroquias);
			info.AddValue("_alreadyFetchedCatZonaPastoralCollectionViaCatParroquias", _alreadyFetchedCatZonaPastoralCollectionViaCatParroquias);
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity entity)
		{
			switch(propertyName)
			{
				...
				case "CatCiudadesCollectionViaCatParroquias":
					...
					break;
				case "CatZonaPastoralCollectionViaCatParroquias":
					_alreadyFetchedCatZonaPastoralCollectionViaCatParroquias = true;
					if(entity!=null)
					{
						this.CatZonaPastoralCollectionViaCatParroquias.Add((ZonaPastoralEntity)entity);
					}
					break;
		...
		public bool TestOriginalFieldValueForNull(TipoParroquiaFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(TipoParroquiaFieldIndex fieldIndex)
		{
		...
		public virtual ORMDiocesis.CollectionClasses.ParroquiaCollection GetMultiCatParroquias(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedCatParroquias || forceFetch || _alwaysFetchCatParroquias) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				_catParroquias.GetMultiManyToOne(null, this, null, filter);
		...
		public ORMDiocesis.CollectionClasses.CiudadCollection GetMultiCatCiudadesCollectionViaCatParroquias(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedCatCiudadesCollectionViaCatParroquias || forceFetch || _alwaysFetchCatCiudadesCollectionViaCatParroquias) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				relations.Add(TipoParroquiaEntity.Relations.ParroquiaEntityUsingIdTipoParroquia, "__TipoParroquiaEntity__", "Parroquia_", JoinHint.None);
				relations.Add(ParroquiaEntity.Relations.CiudadEntityUsingIdCiudad, "Parroquia_", string.Empty, JoinHint.None);
				filter.Add(new FieldCompareValuePredicate(EntityFieldFactory.Create(TipoParroquiaFieldIndex.Id), ComparisonOperator.Equal, this.Id));
		...
		/// <summary> Retrieves all related entities of type 'ZonaPastoralEntity' using a relation of type 'm:n'.</summary>
		/// <param name="forceFetch">if true, it will discard any changes currently in the collection and will rerun the complete query instead</param>
		/// <returns>Filled collection with all related entities of type 'ZonaPastoralEntity'</returns>
		public ORMDiocesis.CollectionClasses.ZonaPastoralCollection GetMultiCatZonaPastoralCollectionViaCatParroquias(bool forceFetch)
		{
			return GetMultiCatZonaPastoralCollectionViaCatParroquias(forceFetch, _catZonaPastoralCollectionViaCatParroquias.EntityFactoryToUse);
		}
		...
		/// <param name="entityFactoryToUse">The entity factory to use for the GetMultiManyToMany() routine.</param>
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public ORMDiocesis.CollectionClasses.ZonaPastoralCollection GetMultiCatZonaPastoralCollectionViaCatParroquias(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedCatZonaPastoralCollectionViaCatParroquias || forceFetch || _alwaysFetchCatZonaPastoralCollectionViaCatParroquias) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				if(base.ParticipatesInTransaction)
				{
					if(!_catZonaPastoralCollectionViaCatParroquias.ParticipatesInTransaction)
					{
						base.Transaction.Add(_catZonaPastoralCollectionViaCatParroquias);
					}
				}
				IRelationCollection relations = new RelationCollection();
				IPredicateExpression filter = new PredicateExpression();
				relations.Add(TipoParroquiaEntity.Relations.ParroquiaEntityUsingIdTipoParroquia, "__TipoParroquiaEntity__", "Parroquia_", JoinHint.None);
				relations.Add(ParroquiaEntity.Relations.ZonaPastoralEntityUsingIdZonaPastoral, "Parroquia_", string.Empty, JoinHint.None);
				filter.Add(new FieldCompareValuePredicate(EntityFieldFactory.Create(TipoParroquiaFieldIndex.Id), ComparisonOperator.Equal, this.Id));
				_catZonaPastoralCollectionViaCatParroquias.SuppressClearInGetMulti=!forceFetch;
				if(entityFactoryToUse!=null)
				{
					_catZonaPastoralCollectionViaCatParroquias.EntityFactoryToUse = entityFactoryToUse;
				}
				_catZonaPastoralCollectionViaCatParroquias.GetMulti(filter, relations);
				_catZonaPastoralCollectionViaCatParroquias.SuppressClearInGetMulti=false;
				_alreadyFetchedCatZonaPastoralCollectionViaCatParroquias = true;
			}
			return _catZonaPastoralCollectionViaCatParroquias;
		}

		/// <summary> Sets the collection parameters for the collection for 'CatZonaPastoralCollectionViaCatParroquias'. These settings will be taken into account
		/// when the property CatZonaPastoralCollectionViaCatParroquias is requested or GetMultiCatZonaPastoralCollectionViaCatParroquias is called.</summary>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return. When set to 0, this parameter is ignored</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified (null), no sorting is applied.</param>
		public virtual void SetCollectionParametersCatZonaPastoralCollectionViaCatParroquias(long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			_catZonaPastoralCollectionViaCatParroquias.SortClauses=sortClauses;
			_catZonaPastoralCollectionViaCatParroquias.MaxNumberOfItemsToReturn=maxNumberOfItemsToReturn;
		}
		...
		protected override bool SetNewFieldValue(int fieldIndex, object value, bool checkForRefetch)
		{
			...
			if(toReturn && Enum.IsDefined(typeof(TipoParroquiaFieldIndex), fieldIndex))
			{
				switch((TipoParroquiaFieldIndex)fieldIndex)
				{
					default:
						break;
				}
		...
		{
			TipoParroquiaDAO dao = (TipoParroquiaDAO)CreateDAOInstance();
		...
		protected override void AddInternalsToContext()
		{
			...
			_catZonaPastoralCollectionViaCatParroquias.ActiveContext = base.ActiveContext;
		...
		/// <param name="id">PK value for TipoParroquia which data should be fetched into this TipoParroquia object</param>
		/// <param name="validator">The validator object for this TipoParroquiaEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		private void InitClassMembers()
		{
			...
			_catParroquias.SetContainingEntityInfo(this, "TipoParroquia");
			...
			_catZonaPastoralCollectionViaCatParroquias = new ORMDiocesis.CollectionClasses.ZonaPastoralCollection(new ZonaPastoralEntityFactory());
			_alwaysFetchCatZonaPastoralCollectionViaCatParroquias = false;
			_alreadyFetchedCatZonaPastoralCollectionViaCatParroquias = false;
		...
		private bool Fetch(System.Byte id, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			try
			{
				...
				base.Fields[(int)TipoParroquiaFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		{
			return DAOFactory.CreateTipoParroquiaDAO();
		}
		...
		{
			return new TipoParroquiaEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static TipoParroquiaRelations Relations
		{
			get	{ return new TipoParroquiaRelations(); }
		}
		...
		public static IPrefetchPathElement PrefetchPathCatParroquias
		{
			get
			{
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.ParroquiaCollection(),
					TipoParroquiaEntity.Relations.ParroquiaEntityUsingIdTipoParroquia, 
					(int)ORMDiocesis.EntityType.TipoParroquiaEntity, (int)ORMDiocesis.EntityType.ParroquiaEntity, 0, null, null, null, "CatParroquias", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathCatCiudadesCollectionViaCatParroquias
		{
			...
			{
				IRelationCollection relations = new RelationCollection();
				relations.Add(TipoParroquiaEntity.Relations.ParroquiaEntityUsingIdTipoParroquia, "__TipoParroquiaEntity__", string.Empty, JoinHint.None);
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.CiudadCollection(),
					TipoParroquiaEntity.Relations.ParroquiaEntityUsingIdTipoParroquia,
					(int)ORMDiocesis.EntityType.TipoParroquiaEntity, (int)ORMDiocesis.EntityType.CiudadEntity, 0, null, null, relations, "CatCiudadesCollectionViaCatParroquias", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathCatZonaPastoralCollectionViaCatParroquias
		{
			get
			{
				IRelationCollection relations = new RelationCollection();
				relations.Add(TipoParroquiaEntity.Relations.ParroquiaEntityUsingIdTipoParroquia, "__TipoParroquiaEntity__", string.Empty, JoinHint.None);
				relations.Add(ParroquiaEntity.Relations.ZonaPastoralEntityUsingIdZonaPastoral);
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.ZonaPastoralCollection(),
					TipoParroquiaEntity.Relations.ParroquiaEntityUsingIdTipoParroquia,
					(int)ORMDiocesis.EntityType.TipoParroquiaEntity, (int)ORMDiocesis.EntityType.ZonaPastoralEntity, 0, null, null, relations, "CatZonaPastoralCollectionViaCatParroquias", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return TipoParroquiaEntity.CustomProperties;}
		}
		...
		{
			get { return TipoParroquiaEntity.FieldsCustomProperties;}
		}

		/// <summary> The Id property of the Entity TipoParroquia<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "CatTipoParroquia"."Idtipoparr"<br/>
		...
		public virtual System.Byte Id
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)TipoParroquiaFieldIndex.Id);
			...
			set	{ SetNewFieldValue((int)TipoParroquiaFieldIndex.Id, value); }
		}
		/// <summary> The Descripcion property of the Entity TipoParroquia<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "CatTipoParroquia"."Desctipoparr"<br/>
		...
		public virtual System.String Descripcion
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)TipoParroquiaFieldIndex.Descripcion);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)TipoParroquiaFieldIndex.Descripcion, value); }
		}
		...
		/// <summary> Retrieves all related entities of type 'ZonaPastoralEntity' using a relation of type 'm:n'.</summary>
		/// <remarks>This property is added for databinding conveniance, however it is recommeded to use the method 'GetMultiCatZonaPastoralCollectionViaCatParroquias()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the same scope.</remarks>
		public virtual ORMDiocesis.CollectionClasses.ZonaPastoralCollection CatZonaPastoralCollectionViaCatParroquias
		{
			get { return GetMultiCatZonaPastoralCollectionViaCatParroquias(false); }
		}

		/// <summary> Gets / sets the lazy loading flag for CatZonaPastoralCollectionViaCatParroquias. When set to true, CatZonaPastoralCollectionViaCatParroquias is always refetched from the 
		/// persistent storage. When set to false, the data is only fetched the first time CatZonaPastoralCollectionViaCatParroquias is accessed. You can always execute
		/// a forced fetch by calling GetMultiCatZonaPastoralCollectionViaCatParroquias(true).</summary>
		[Browsable(false)]
		public bool AlwaysFetchCatZonaPastoralCollectionViaCatParroquias
		{
			get	{ return _alwaysFetchCatZonaPastoralCollectionViaCatParroquias; }
			set	{ _alwaysFetchCatZonaPastoralCollectionViaCatParroquias = value; }	
		}
		...
		{ 
			get { return (int)ORMDiocesis.EntityType.TipoParroquiaEntity; }
		}
		#endregion
