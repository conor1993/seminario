...
namespace ORMDiocesis.HelperClasses
{
	...
	internal class FieldInfoProviderCore : FieldInfoProviderBase
	{
		...
		{
			base.AddElementFieldInfo("AutorEntity", "Id", typeof(System.Int32), true, false, false, false,  (int)AutorFieldIndex.Id, 0, 0, 10);
		...
		{
			base.AddElementFieldInfo("EditorialEntity", "Id", typeof(System.Int32), true, false, false, false,  (int)EditorialFieldIndex.Id, 0, 0, 10);
		...
		{
			base.AddElementFieldInfo("LibroEntity", "Id", typeof(System.Int32), true, false, false, false,  (int)LibroFieldIndex.Id, 0, 0, 10);
		...
		{
			base.AddElementFieldInfo("PaisEntity", "Id", typeof(System.Int32), true, false, false, false,  (int)PaisFieldIndex.Id, 0, 0, 10);
		...
		{
			base.AddElementFieldInfo("RamaEntity", "IdSeccion", typeof(System.Int32), false, true, false, false,  (int)RamaFieldIndex.IdSeccion, 0, 0, 10);
			base.AddElementFieldInfo("RamaEntity", "Id", typeof(System.Int32), true, false, false, false,  (int)RamaFieldIndex.Id, 0, 0, 10);
		...
		{
			base.AddElementFieldInfo("SeccionEntity", "Id", typeof(System.Int32), true, false, false, false,  (int)SeccionFieldIndex.Id, 0, 0, 10);
		...
		{
			base.AddElementFieldInfo("TematicaEntity", "IdSeccion", typeof(System.Int32), false, true, false, false,  (int)TematicaFieldIndex.IdSeccion, 0, 0, 10);
			base.AddElementFieldInfo("TematicaEntity", "IdRama", typeof(System.Int32), false, true, false, false,  (int)TematicaFieldIndex.IdRama, 0, 0, 10);
			base.AddElementFieldInfo("TematicaEntity", "Id", typeof(System.Int32), true, false, false, false,  (int)TematicaFieldIndex.Id, 0, 0, 10);
