...
namespace ORMDiocesis.HelperClasses
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		private void InitAutorEntityMappings()
		{
			...
			base.AddElementFieldMapping( "AutorEntity", "Id", "Id", false, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 0 );
		...
		private void InitEditorialEntityMappings()
		{
			...
			base.AddElementFieldMapping( "EditorialEntity", "Id", "Id", false, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 0 );
		...
		{
			base.AddElementMapping( "LibroEntity", "bdsemprovoc", @"dbo", "BInvLibros", 20 );
			base.AddElementFieldMapping( "LibroEntity", "Id", "Id", false, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 0 );
		...
		private void InitPaisEntityMappings()
		{
			...
			base.AddElementFieldMapping( "PaisEntity", "Id", "Id", false, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 0 );
		...
		{
			base.AddElementMapping( "RamaEntity", "bdsemprovoc", @"dbo", "BCatRamas", 3 );
			base.AddElementFieldMapping( "RamaEntity", "IdSeccion", "IdSeccion", false, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 0 );
			base.AddElementFieldMapping( "RamaEntity", "Id", "Id", false, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 1 );
			base.AddElementFieldMapping( "RamaEntity", "Nombre", "Nombre", false, (int)SqlDbType.VarChar, 50, 0, 0, false, "", null, typeof(System.String), 2 );
		}
		...
		private void InitSeccionEntityMappings()
		{
			...
			base.AddElementFieldMapping( "SeccionEntity", "Id", "Id", false, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 0 );
		...
		{
			base.AddElementMapping( "TematicaEntity", "bdsemprovoc", @"dbo", "BCatTematicas", 4 );
			base.AddElementFieldMapping( "TematicaEntity", "IdSeccion", "IdSeccion", false, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 0 );
			base.AddElementFieldMapping( "TematicaEntity", "IdRama", "IdRama", false, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 1 );
			base.AddElementFieldMapping( "TematicaEntity", "Id", "Id", false, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 2 );
			base.AddElementFieldMapping( "TematicaEntity", "Nombre", "Nombre", false, (int)SqlDbType.VarChar, 20, 0, 0, false, "", null, typeof(System.String), 3 );
		}
