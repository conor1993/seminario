...
namespace ClasesNegocio
{
    ...
    public partial class Controlador
    {
        ...
        private void HabilitarMenu(string IdMenu, ToolStripItemCollection Menus)
        {
            foreach (ToolStripItem Item in Menus)
            {
                if (Item.Name == IdMenu && Item.GetType() == Type.GetType("System.Windows.Forms.ToolStripMenuItem"))
                {
                    Item.Visible = true;
                ...
                {
                    if (Item.GetType() == Type.GetType("System.Windows.Forms.ToolStripMenuItem") && ((ToolStripMenuItem)Item).DropDownItems != null)
        ...
        public void ActualizarMenu(MenuStrip MenuPrincipal, String Empresa = null)
        {
            ...
            {
                Empresa = Controlador.Sesion.MiEmpresa.Empnom;
            }
