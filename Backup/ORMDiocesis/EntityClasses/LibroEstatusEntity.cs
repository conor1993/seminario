...
namespace ORMDiocesis.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'LibroEstatus'. <br/><br/>
	/// 
	/// </summary>
#if CF
	...
	[Serializable]
#endif
	public partial class LibroEstatusEntity : EntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static LibroEstatusEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public LibroEstatusEntity()
		{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for LibroEstatus which data should be fetched into this LibroEstatus object</param>
		public LibroEstatusEntity(System.Int32 id)
		{
		...
		public LibroEstatusEntity(System.Int32 id, IPrefetchPath prefetchPathToUse)
		{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for LibroEstatus which data should be fetched into this LibroEstatus object</param>
		/// <param name="validator">The custom validator object for this LibroEstatusEntity</param>
		public LibroEstatusEntity(System.Int32 id, IValidator validator)
		{
		...
		protected LibroEstatusEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		public bool TestOriginalFieldValueForNull(LibroEstatusFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(LibroEstatusFieldIndex fieldIndex)
		{
		...
		public virtual ORMDiocesis.CollectionClasses.LibroCollection GetMultiLibro(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedLibro || forceFetch || _alwaysFetchLibro) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				_libro.GetMultiManyToOne(null, null, null, null, null, null, this, null, filter);
		...
		public ORMDiocesis.CollectionClasses.AutorCollection GetMultiAutorCollectionViaLibro(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedAutorCollectionViaLibro || forceFetch || _alwaysFetchAutorCollectionViaLibro) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				relations.Add(LibroEstatusEntity.Relations.LibroEntityUsingEstatus, "__LibroEstatusEntity__", "Libro_", JoinHint.None);
				relations.Add(LibroEntity.Relations.AutorEntityUsingIdAutor, "Libro_", string.Empty, JoinHint.None);
				filter.Add(new FieldCompareValuePredicate(EntityFieldFactory.Create(LibroEstatusFieldIndex.Id), ComparisonOperator.Equal, this.Id));
		...
		protected override bool SetNewFieldValue(int fieldIndex, object value, bool checkForRefetch)
		{
			...
			if(toReturn && Enum.IsDefined(typeof(LibroEstatusFieldIndex), fieldIndex))
			{
				switch((LibroEstatusFieldIndex)fieldIndex)
				{
					default:
						break;
				}
		...
		{
			LibroEstatusDAO dao = (LibroEstatusDAO)CreateDAOInstance();
		...
		/// <param name="id">PK value for LibroEstatus which data should be fetched into this LibroEstatus object</param>
		/// <param name="validator">The validator object for this LibroEstatusEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		private void InitClassMembers()
		{
			...
			_libro.SetContainingEntityInfo(this, "BcatEstatus");
		...
		private bool Fetch(System.Int32 id, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			try
			{
				...
				base.Fields[(int)LibroEstatusFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		{
			return new LibroEstatusEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static LibroEstatusRelations Relations
		{
			get	{ return new LibroEstatusRelations(); }
		}
		...
		public static IPrefetchPathElement PrefetchPathLibro
		{
			get
			{
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroCollection(),
					LibroEstatusEntity.Relations.LibroEntityUsingEstatus, 
					(int)ORMDiocesis.EntityType.LibroEstatusEntity, (int)ORMDiocesis.EntityType.LibroEntity, 0, null, null, null, "Libro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathAutorCollectionViaLibro
		{
			...
			{
				IRelationCollection relations = new RelationCollection();
				relations.Add(LibroEstatusEntity.Relations.LibroEntityUsingEstatus, "__LibroEstatusEntity__", string.Empty, JoinHint.None);
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.AutorCollection(),
					LibroEstatusEntity.Relations.LibroEntityUsingEstatus,
					(int)ORMDiocesis.EntityType.LibroEstatusEntity, (int)ORMDiocesis.EntityType.AutorEntity, 0, null, null, relations, "AutorCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathEditorialCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.EditorialCollection(),
					LibroEstatusEntity.Relations.LibroEntityUsingEstatus,
					(int)ORMDiocesis.EntityType.LibroEstatusEntity, (int)ORMDiocesis.EntityType.EditorialEntity, 0, null, null, relations, "EditorialCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathRamaCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.RamaCollection(),
					LibroEstatusEntity.Relations.LibroEntityUsingEstatus,
					(int)ORMDiocesis.EntityType.LibroEstatusEntity, (int)ORMDiocesis.EntityType.RamaEntity, 0, null, null, relations, "RamaCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathSeccionCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.SeccionCollection(),
					LibroEstatusEntity.Relations.LibroEntityUsingEstatus,
					(int)ORMDiocesis.EntityType.LibroEstatusEntity, (int)ORMDiocesis.EntityType.SeccionEntity, 0, null, null, relations, "SeccionCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathTematicaCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.TematicaCollection(),
					LibroEstatusEntity.Relations.LibroEntityUsingEstatus,
					(int)ORMDiocesis.EntityType.LibroEstatusEntity, (int)ORMDiocesis.EntityType.TematicaEntity, 0, null, null, relations, "TematicaCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathPaisCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.PaisCollection(),
					LibroEstatusEntity.Relations.LibroEntityUsingEstatus,
					(int)ORMDiocesis.EntityType.LibroEstatusEntity, (int)ORMDiocesis.EntityType.PaisEntity, 0, null, null, relations, "PaisCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathBcatFormatoCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroFormatoCollection(),
					LibroEstatusEntity.Relations.LibroEntityUsingEstatus,
					(int)ORMDiocesis.EntityType.LibroEstatusEntity, (int)ORMDiocesis.EntityType.LibroFormatoEntity, 0, null, null, relations, "BcatFormatoCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return LibroEstatusEntity.CustomProperties;}
		}
		...
		{
			get { return LibroEstatusEntity.FieldsCustomProperties;}
		}

		/// <summary> The Id property of the Entity LibroEstatus<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BCatEstatus"."Id"<br/>
		...
		public virtual System.Int32 Id
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)LibroEstatusFieldIndex.Id);
			...
			set	{ SetNewFieldValue((int)LibroEstatusFieldIndex.Id, value); }
		}
		/// <summary> The Estado property of the Entity LibroEstatus<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BCatEstatus"."Estado"<br/>
		...
		public virtual System.String Estado
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)LibroEstatusFieldIndex.Estado);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)LibroEstatusFieldIndex.Estado, value); }
		}
		...
		{ 
			get { return (int)ORMDiocesis.EntityType.LibroEstatusEntity; }
		}
		#endregion
