...
namespace ORMDiocesis.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Pais Entity. It will perform database oriented actions for
	/// a entity of type 'PaisEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class PaisDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public PaisDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "PaisEntity", new PaisEntityFactory())
		{
		}
		...
		internal PaisDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'PaisEntity' in a datatable which match the specified filter. 
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(ORMDiocesis.EntityType.PaisEntity);
		...
		/// <summary>
		/// Retrieves in the calling PaisCollection object all PaisEntity objects
		...
		public bool GetMultiUsingBcatEstatusCollectionViaLibro(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity libroEstatusInstance, int pageNumber, int pageSize)
		{
			...
			relations.Add(PaisEntity.Relations.LibroEntityUsingIdPais, "Libro_");
