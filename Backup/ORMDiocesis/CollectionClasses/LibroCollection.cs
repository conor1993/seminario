...
namespace ORMDiocesis.CollectionClasses
{
	...
	public partial class LibroCollection : EntityCollectionBase<LibroEntity>
	{
		...
		public bool GetMultiManyToOne(IEntity autorInstance, IEntity editorialInstance, IEntity ramaInstance, IEntity seccionInstance, IEntity tematicaInstance, IEntity paisInstance, IEntity bcatEstatusInstance, IEntity bcatFormatoInstance)
		{
			return GetMultiManyToOne(autorInstance, editorialInstance, ramaInstance, seccionInstance, tematicaInstance, paisInstance, bcatEstatusInstance, bcatFormatoInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity autorInstance, IEntity editorialInstance, IEntity ramaInstance, IEntity seccionInstance, IEntity tematicaInstance, IEntity paisInstance, IEntity bcatEstatusInstance, IEntity bcatFormatoInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(autorInstance, editorialInstance, ramaInstance, seccionInstance, tematicaInstance, paisInstance, bcatEstatusInstance, bcatFormatoInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter, 0, 0);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity autorInstance, IEntity editorialInstance, IEntity ramaInstance, IEntity seccionInstance, IEntity tematicaInstance, IEntity paisInstance, IEntity bcatEstatusInstance, IEntity bcatFormatoInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			return GetMultiManyToOne(autorInstance, editorialInstance, ramaInstance, seccionInstance, tematicaInstance, paisInstance, bcatEstatusInstance, bcatFormatoInstance, maxNumberOfItemsToReturn, sortClauses, filter, 0, 0);
		}
		...
		public virtual bool GetMultiManyToOne(IEntity autorInstance, IEntity editorialInstance, IEntity ramaInstance, IEntity seccionInstance, IEntity tematicaInstance, IEntity paisInstance, IEntity bcatEstatusInstance, IEntity bcatFormatoInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, filter, autorInstance, editorialInstance, ramaInstance, seccionInstance, tematicaInstance, paisInstance, bcatEstatusInstance, bcatFormatoInstance, pageNumber, pageSize);
		}
		...
		public int DeleteMultiManyToOne(IEntity autorInstance, IEntity editorialInstance, IEntity ramaInstance, IEntity seccionInstance, IEntity tematicaInstance, IEntity paisInstance, IEntity bcatEstatusInstance, IEntity bcatFormatoInstance)
		{
			LibroDAO dao = DAOFactory.CreateLibroDAO();
			return dao.DeleteMulti(base.Transaction, autorInstance, editorialInstance, ramaInstance, seccionInstance, tematicaInstance, paisInstance, bcatEstatusInstance, bcatFormatoInstance);
		}
		...
		/// <param name="bcatFormatoInstance">LibroFormatoEntity instance to use as a filter for the LibroEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(LibroEntity entityWithNewValues, IEntity autorInstance, IEntity editorialInstance, IEntity ramaInstance, IEntity seccionInstance, IEntity tematicaInstance, IEntity paisInstance, IEntity bcatEstatusInstance, IEntity bcatFormatoInstance)
		{
			LibroDAO dao = DAOFactory.CreateLibroDAO();
			return dao.UpdateMulti(entityWithNewValues, base.Transaction, autorInstance, editorialInstance, ramaInstance, seccionInstance, tematicaInstance, paisInstance, bcatEstatusInstance, bcatFormatoInstance);
		}
