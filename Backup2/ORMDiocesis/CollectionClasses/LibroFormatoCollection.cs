...
namespace ORMDiocesis.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of LibroFormatoEntity objects. </summary>
#if CF
	[SD.LLBLGen.Pro.ORMSupportClasses.Serializable]
#else
	[Serializable]
#endif
	public partial class LibroFormatoCollection : EntityCollectionBase<LibroFormatoEntity>
	{
		/// <summary> CTor</summary>
		public LibroFormatoCollection():base(new LibroFormatoEntityFactory())
		{
		}

		/// <summary> CTor</summary>
		/// <param name="initialContents">The initial contents of this collection.</param>
		public LibroFormatoCollection(IList<LibroFormatoEntity> initialContents):base(new LibroFormatoEntityFactory())
		{
		}

		/// <summary> CTor</summary>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public LibroFormatoCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected LibroFormatoCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}



		/// <summary> Retrieves in this LibroFormatoCollection object all LibroFormatoEntity objects which are related via a  Relation of type 'm:n' with the passed in AutorEntity. 
		...
		public virtual bool GetMultiManyToManyUsingAutorCollectionViaLibro(IEntity autorInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			...
			LibroFormatoDAO dao = DAOFactory.CreateLibroFormatoDAO();
		...
		/// <summary> Retrieves in this LibroFormatoCollection object all LibroFormatoEntity objects which are related via a  Relation of type 'm:n' with the passed in EditorialEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this LibroFormatoCollection object all LibroFormatoEntity objects which are related via a  Relation of type 'm:n' with the passed in LibroEstatusEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		/// <param name="libroEstatusInstance">LibroEstatusEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingLibroEstatusCollectionViaLibro(IEntity libroEstatusInstance)
		{
			return GetMultiManyToManyUsingLibroEstatusCollectionViaLibro(libroEstatusInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, 0, 0);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingLibroEstatusCollectionViaLibro(IEntity libroEstatusInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			return GetMultiManyToManyUsingLibroEstatusCollectionViaLibro(libroEstatusInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0);
		}
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToManyUsingLibroEstatusCollectionViaLibro(IEntity libroEstatusInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			LibroFormatoDAO dao = DAOFactory.CreateLibroFormatoDAO();
			return dao.GetMultiUsingLibroEstatusCollectionViaLibro(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, libroEstatusInstance, pageNumber, pageSize);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingLibroEstatusCollectionViaLibro(IEntity libroEstatusInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingLibroEstatusCollectionViaLibro(libroEstatusInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, prefetchPathToUse);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingLibroEstatusCollectionViaLibro(IEntity libroEstatusInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			LibroFormatoDAO dao = DAOFactory.CreateLibroFormatoDAO();
			return dao.GetMultiUsingLibroEstatusCollectionViaLibro(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, libroEstatusInstance, prefetchPathToUse);
		}

		/// <summary> Retrieves in this LibroFormatoCollection object all LibroFormatoEntity objects which are related via a  Relation of type 'm:n' with the passed in RamaEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this LibroFormatoCollection object all LibroFormatoEntity objects which are related via a  Relation of type 'm:n' with the passed in SeccionEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this LibroFormatoCollection object all LibroFormatoEntity objects which are related via a  Relation of type 'm:n' with the passed in TematicaEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this LibroFormatoCollection object all LibroFormatoEntity objects which are related via a  Relation of type 'm:n' with the passed in PaisEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Deletes from the persistent storage all LibroFormato entities which match with the specified filter, formulated in the predicate or predicate expression definition.</summary>
		/// <param name="deleteFilter">A predicate or predicate expression which should be used as filter for the entities to delete. Can be null, which will result in a query removing all LibroFormato entities from the persistent storage</param>
		...
		/// <summary> Updates in the persistent storage all entities which have data in common with the specified LibroFormatoEntity. If one is omitted that entity is not used as a filter. Which fields are updated in those matching entities depends on which fields are
		/// <i>changed</i> in entityWithNewValues. The new values of these fields are read from entityWithNewValues. </summary>
		/// <param name="entityWithNewValues">LibroFormatoEntity instance which holds the new values for the matching entities to update. Only changed fields are taken into account</param>
		...
		/// will result in an update action which will affect all LibroFormato entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(LibroFormatoEntity entityWithNewValues, IPredicate updateFilter)
		{
			LibroFormatoDAO dao = DAOFactory.CreateLibroFormatoDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(LibroFormatoEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			LibroFormatoDAO dao = DAOFactory.CreateLibroFormatoDAO();
		...
		public object GetScalar(LibroFormatoFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(LibroFormatoFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(LibroFormatoFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(LibroFormatoFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(LibroFormatoFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
