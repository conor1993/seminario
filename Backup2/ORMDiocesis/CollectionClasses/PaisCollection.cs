...
namespace ORMDiocesis.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of PaisEntity objects. </summary>
#if CF
	[SD.LLBLGen.Pro.ORMSupportClasses.Serializable]
#else
	[Serializable]
#endif
	public partial class PaisCollection : EntityCollectionBase<PaisEntity>
	{
		/// <summary> CTor</summary>
		public PaisCollection():base(new PaisEntityFactory())
		{
		}

		/// <summary> CTor</summary>
		/// <param name="initialContents">The initial contents of this collection.</param>
		public PaisCollection(IList<PaisEntity> initialContents):base(new PaisEntityFactory())
		{
		}

		/// <summary> CTor</summary>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public PaisCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected PaisCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}



		/// <summary> Retrieves in this PaisCollection object all PaisEntity objects which are related via a  Relation of type 'm:n' with the passed in LibroEstatusEntity. 
		...
		public virtual bool GetMultiManyToManyUsingBcatEstatusCollectionViaLibro(IEntity libroEstatusInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			...
			PaisDAO dao = DAOFactory.CreatePaisDAO();
		...
		/// <summary> Retrieves in this PaisCollection object all PaisEntity objects which are related via a  Relation of type 'm:n' with the passed in LibroFormatoEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this PaisCollection object all PaisEntity objects which are related via a  Relation of type 'm:n' with the passed in RamaEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this PaisCollection object all PaisEntity objects which are related via a  Relation of type 'm:n' with the passed in SeccionEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this PaisCollection object all PaisEntity objects which are related via a  Relation of type 'm:n' with the passed in TematicaEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Deletes from the persistent storage all Pais entities which match with the specified filter, formulated in the predicate or predicate expression definition.</summary>
		/// <param name="deleteFilter">A predicate or predicate expression which should be used as filter for the entities to delete. Can be null, which will result in a query removing all Pais entities from the persistent storage</param>
		...
		/// <summary> Updates in the persistent storage all entities which have data in common with the specified PaisEntity. If one is omitted that entity is not used as a filter. Which fields are updated in those matching entities depends on which fields are
		/// <i>changed</i> in entityWithNewValues. The new values of these fields are read from entityWithNewValues. </summary>
		/// <param name="entityWithNewValues">PaisEntity instance which holds the new values for the matching entities to update. Only changed fields are taken into account</param>
		...
		/// will result in an update action which will affect all Pais entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(PaisEntity entityWithNewValues, IPredicate updateFilter)
		{
			PaisDAO dao = DAOFactory.CreatePaisDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(PaisEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			PaisDAO dao = DAOFactory.CreatePaisDAO();
		...
		public object GetScalar(PaisFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(PaisFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(PaisFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(PaisFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(PaisFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
