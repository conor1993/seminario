...
namespace ORMDiocesis.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the LibroEstatus Entity. It will perform database oriented actions for
	/// a entity of type 'LibroEstatusEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class LibroEstatusDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public LibroEstatusDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "LibroEstatusEntity", new LibroEstatusEntityFactory())
		{
		}
		...
		internal LibroEstatusDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'LibroEstatusEntity' in a datatable which match the specified filter. 
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(ORMDiocesis.EntityType.LibroEstatusEntity);
		...
		/// <summary>
		/// Retrieves in the calling LibroEstatusCollection object all LibroEstatusEntity objects
		...
		public bool GetMultiUsingAutorCollectionViaLibro(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity autorInstance, int pageNumber, int pageSize)
		{
			...
			relations.Add(LibroEstatusEntity.Relations.LibroEntityUsingEstatus, "Libro_");
