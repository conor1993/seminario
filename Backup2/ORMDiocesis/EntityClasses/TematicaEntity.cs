			...
			
	{
		...
		public ORMDiocesis.CollectionClasses.AutorCollection GetMultiAutorCollectionViaLibro(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedAutorCollectionViaLibro || forceFetch || _alwaysFetchAutorCollectionViaLibro) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				relations.Add(TematicaEntity.Relations.LibroEntityUsingIdTematica, "__TematicaEntity__", "Libro_", JoinHint.None);
				relations.Add(LibroEntity.Relations.AutorEntityUsingIdAutor, "Libro_", string.Empty, JoinHint.None);
				filter.Add(new FieldCompareValuePredicate(EntityFieldFactory.Create(TematicaFieldIndex.Id), ComparisonOperator.Equal, this.Id));
		...
		private void InitClassMembers()
		{
			...
			_libro.SetContainingEntityInfo(this, "Tematica");
		...
		public static IPrefetchPathElement PrefetchPathLibro
		{
			get
			{
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroCollection(),
					...
					(int)ORMDiocesis.EntityType.TematicaEntity, (int)ORMDiocesis.EntityType.LibroEntity, 0, null, null, null, "Libro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathAutorCollectionViaLibro
		{
			...
			{
				IRelationCollection relations = new RelationCollection();
				relations.Add(TematicaEntity.Relations.LibroEntityUsingIdTematica, "__TematicaEntity__", string.Empty, JoinHint.None);
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.AutorCollection(),
					TematicaEntity.Relations.LibroEntityUsingIdTematica,
					(int)ORMDiocesis.EntityType.TematicaEntity, (int)ORMDiocesis.EntityType.AutorEntity, 0, null, null, relations, "AutorCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathEditorialCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.EditorialCollection(),
					TematicaEntity.Relations.LibroEntityUsingIdTematica,
					(int)ORMDiocesis.EntityType.TematicaEntity, (int)ORMDiocesis.EntityType.EditorialEntity, 0, null, null, relations, "EditorialCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathBcatEstatusCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroEstatusCollection(),
					TematicaEntity.Relations.LibroEntityUsingIdTematica,
					(int)ORMDiocesis.EntityType.TematicaEntity, (int)ORMDiocesis.EntityType.LibroEstatusEntity, 0, null, null, relations, "BcatEstatusCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathBcatFormatoCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.LibroFormatoCollection(),
					TematicaEntity.Relations.LibroEntityUsingIdTematica,
					(int)ORMDiocesis.EntityType.TematicaEntity, (int)ORMDiocesis.EntityType.LibroFormatoEntity, 0, null, null, relations, "BcatFormatoCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathRamaCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.RamaCollection(),
					TematicaEntity.Relations.LibroEntityUsingIdTematica,
					(int)ORMDiocesis.EntityType.TematicaEntity, (int)ORMDiocesis.EntityType.RamaEntity, 0, null, null, relations, "RamaCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathSeccionCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.SeccionCollection(),
					TematicaEntity.Relations.LibroEntityUsingIdTematica,
					(int)ORMDiocesis.EntityType.TematicaEntity, (int)ORMDiocesis.EntityType.SeccionEntity, 0, null, null, relations, "SeccionCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathPaisCollectionViaLibro
		{
			get
			{
				...
				return new PrefetchPathElement(new ORMDiocesis.CollectionClasses.PaisCollection(),
					TematicaEntity.Relations.LibroEntityUsingIdTematica,
					(int)ORMDiocesis.EntityType.TematicaEntity, (int)ORMDiocesis.EntityType.PaisEntity, 0, null, null, relations, "PaisCollectionViaLibro", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
