...
namespace ORMDiocesis.FactoryClasses
{
	...
	public partial class EntityFieldFactory
	{
		...
		/// <summary>
		/// Creates a new IEntityField instance for usage in the EntityFields object for the CargoEntity. 
		/// Which EntityField is created is specified by fieldIndex
		/// </summary>
		/// <param name="fieldIndex">The field which IEntityField instance should be created</param>
		/// <returns>The IEntityField instance for the field specified in fieldIndex</returns>
		public static IEntityField Create(CargoFieldIndex fieldIndex)
		{
			IEntityField fieldToReturn = null;
			IFieldInfoProvider fieldProvider = FieldInfoProviderSingleton.GetInstance();
			IPersistenceInfoProvider persistenceProvider = PersistenceInfoProviderSingleton.GetInstance();
			switch(fieldIndex)
			{
				case CargoFieldIndex.Id:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("CargoEntity", "Id"), persistenceProvider.GetFieldPersistenceInfo("CargoEntity", "Id"));
					break;
				case CargoFieldIndex.Cargo:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("CargoEntity", "Cargo"), persistenceProvider.GetFieldPersistenceInfo("CargoEntity", "Cargo"));
					break;
		...
		/// <summary>
		/// Creates a new IEntityField instance for usage in the EntityFields object for the LectoresEntity. 
		/// Which EntityField is created is specified by fieldIndex
		/// </summary>
		/// <param name="fieldIndex">The field which IEntityField instance should be created</param>
		/// <returns>The IEntityField instance for the field specified in fieldIndex</returns>
		public static IEntityField Create(LectoresFieldIndex fieldIndex)
		{
			IEntityField fieldToReturn = null;
			IFieldInfoProvider fieldProvider = FieldInfoProviderSingleton.GetInstance();
			IPersistenceInfoProvider persistenceProvider = PersistenceInfoProviderSingleton.GetInstance();
			switch(fieldIndex)
			{
				case LectoresFieldIndex.IdLectores:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "IdLectores"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "IdLectores"));
					break;
				case LectoresFieldIndex.Matricula:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Matricula"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Matricula"));
					break;
				case LectoresFieldIndex.Nombre:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Nombre"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Nombre"));
					break;
				case LectoresFieldIndex.ApellidoPaterno:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "ApellidoPaterno"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "ApellidoPaterno"));
					break;
				case LectoresFieldIndex.ApellidoMaterno:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "ApellidoMaterno"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "ApellidoMaterno"));
					break;
				case LectoresFieldIndex.Sexo:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Sexo"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Sexo"));
					break;
				case LectoresFieldIndex.Grupo:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Grupo"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Grupo"));
					break;
				case LectoresFieldIndex.FechaNacimiento:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "FechaNacimiento"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "FechaNacimiento"));
					break;
				case LectoresFieldIndex.CalleNumero:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "CalleNumero"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "CalleNumero"));
					break;
				case LectoresFieldIndex.Ciudad:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Ciudad"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Ciudad"));
					break;
				case LectoresFieldIndex.Estado:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Estado"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Estado"));
					break;
				case LectoresFieldIndex.Telefono:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Telefono"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Telefono"));
					break;
				case LectoresFieldIndex.Celular:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Celular"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Celular"));
					break;
				case LectoresFieldIndex.Facultad:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Facultad"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Facultad"));
					break;
				case LectoresFieldIndex.FechaAlta:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "FechaAlta"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "FechaAlta"));
					break;
				case LectoresFieldIndex.FechaVigencia:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "FechaVigencia"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "FechaVigencia"));
					break;
				case LectoresFieldIndex.Baja:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Baja"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Baja"));
					break;
				case LectoresFieldIndex.Suspendido:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Suspendido"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Suspendido"));
					break;
				case LectoresFieldIndex.FechaBaja:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "FechaBaja"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "FechaBaja"));
					break;
				case LectoresFieldIndex.MotivoBaja:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "MotivoBaja"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "MotivoBaja"));
					break;
				case LectoresFieldIndex.MotivoSuspendido:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "MotivoSuspendido"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "MotivoSuspendido"));
					break;
				case LectoresFieldIndex.InicioSuspension:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "InicioSuspension"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "InicioSuspension"));
					break;
				case LectoresFieldIndex.DiasSuspension:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "DiasSuspension"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "DiasSuspension"));
					break;
				case LectoresFieldIndex.Observaciones:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Observaciones"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Observaciones"));
					break;
				case LectoresFieldIndex.Cp:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Cp"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Cp"));
					break;
				case LectoresFieldIndex.Facebook:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Facebook"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Facebook"));
					break;
				case LectoresFieldIndex.Numero:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Numero"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Numero"));
					break;
				case LectoresFieldIndex.Colonia:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Colonia"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Colonia"));
					break;
				case LectoresFieldIndex.Email:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LectoresEntity", "Email"), persistenceProvider.GetFieldPersistenceInfo("LectoresEntity", "Email"));
					break;
		...
		public static IEntityField Create(LibroFieldIndex fieldIndex)
		{
			...
			switch(fieldIndex)
			{
				...
				case LibroFieldIndex.Busqueda:
					...
					break;
				case LibroFieldIndex.Portada:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LibroEntity", "Portada"), persistenceProvider.GetFieldPersistenceInfo("LibroEntity", "Portada"));
					break;
				case LibroFieldIndex.ContraPortada:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LibroEntity", "ContraPortada"), persistenceProvider.GetFieldPersistenceInfo("LibroEntity", "ContraPortada"));
					break;
				case LibroFieldIndex.Materia:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LibroEntity", "Materia"), persistenceProvider.GetFieldPersistenceInfo("LibroEntity", "Materia"));
					break;
				case LibroFieldIndex.Formato:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LibroEntity", "Formato"), persistenceProvider.GetFieldPersistenceInfo("LibroEntity", "Formato"));
					break;
				case LibroFieldIndex.Estatus:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LibroEntity", "Estatus"), persistenceProvider.GetFieldPersistenceInfo("LibroEntity", "Estatus"));
					break;
				case LibroFieldIndex.Numero:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LibroEntity", "Numero"), persistenceProvider.GetFieldPersistenceInfo("LibroEntity", "Numero"));
					break;
		...
		/// <summary>
		/// Creates a new IEntityField instance for usage in the EntityFields object for the LibroEstatusEntity. 
		/// Which EntityField is created is specified by fieldIndex
		/// </summary>
		/// <param name="fieldIndex">The field which IEntityField instance should be created</param>
		/// <returns>The IEntityField instance for the field specified in fieldIndex</returns>
		public static IEntityField Create(LibroEstatusFieldIndex fieldIndex)
		{
			IEntityField fieldToReturn = null;
			IFieldInfoProvider fieldProvider = FieldInfoProviderSingleton.GetInstance();
			IPersistenceInfoProvider persistenceProvider = PersistenceInfoProviderSingleton.GetInstance();
			switch(fieldIndex)
			{
				case LibroEstatusFieldIndex.Id:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LibroEstatusEntity", "Id"), persistenceProvider.GetFieldPersistenceInfo("LibroEstatusEntity", "Id"));
					break;
				case LibroEstatusFieldIndex.Estado:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LibroEstatusEntity", "Estado"), persistenceProvider.GetFieldPersistenceInfo("LibroEstatusEntity", "Estado"));
					break;
		...
		/// <summary>
		/// Creates a new IEntityField instance for usage in the EntityFields object for the LibroFormatoEntity. 
		/// Which EntityField is created is specified by fieldIndex
		/// </summary>
		/// <param name="fieldIndex">The field which IEntityField instance should be created</param>
		/// <returns>The IEntityField instance for the field specified in fieldIndex</returns>
		public static IEntityField Create(LibroFormatoFieldIndex fieldIndex)
		{
			IEntityField fieldToReturn = null;
			IFieldInfoProvider fieldProvider = FieldInfoProviderSingleton.GetInstance();
			IPersistenceInfoProvider persistenceProvider = PersistenceInfoProviderSingleton.GetInstance();
			switch(fieldIndex)
			{
				case LibroFormatoFieldIndex.Id:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LibroFormatoEntity", "Id"), persistenceProvider.GetFieldPersistenceInfo("LibroFormatoEntity", "Id"));
					break;
				case LibroFormatoFieldIndex.Formato:
					fieldToReturn = new EntityField(fieldProvider.GetFieldInfo("LibroFormatoEntity", "Formato"), persistenceProvider.GetFieldPersistenceInfo("LibroFormatoEntity", "Formato"));
					break;
